...
export const translations = {
    ...
    om: {
            ...
            Keepaney45eon3: "Appii hawaasummaa 30+ hordofuun dursanii balaa qaqabuu.",
            ...
            AIscans30appsli: "AI apps 30+ kan akka TikTok & Instagram scan godhee ijjoollee keessan sosodaachisuu, fi qabiyyee miidhaa geessisu dursee adda ba'a.",
            ...
            ControlFeatures: "maatii Dabalataaf Qoradhu",
            feaxturess: [
            ...
            StartFreeTrial: "Bilisaa Yaali",
            BuyNow: "Amma Bitadhaa",
            ...
            cardss: [
                {
                    title: "FamiSafe🔥 👑",
                    desc: "Jireenya dijitaalaa ijoollee keessanii Eegaa",
                    img: 'https://famisafe.wondershare.com/images/images-2025/famisafe/home-icon.svg',
                    primary: true,
                    href: "/famisafe",
                },
                {
                    title: "Famisafe Mana Barmasaf, ",
                    desc: "Mana barumsaa  & Warra Walitti Hidhamsiisu",
                    img: 'https://famisafe.wondershare.com/images/images-2025/famisafe/school-icon.svg',
                    href: "/school", // School link
                },
                {
                    title: "Geonection jedhamuun beekama",
                    desc: "Fageenya Riqichaa Xiin-sammuudhaan Tokkummaa",
                    img: 'https://famisafe.wondershare.com/images/images-2025/famisafe/geonection-icon.svg',
                    href: "/Geonection", // Geonection link
                },
            ],
            ...
            columns: [
                {
                    ...
                    bg: "#f5f1ff",
                    features: [
                        { title: "Bilbilaa fi Ergaa", newTag: true, link: "/Call-meassage" },
                        { title: "Yeroo Iskiriinii ", newTag: true, link: "/Screen-Time" },
                        { title: "Ilaaltuu Iskiriinii ", link: "/Screen-Viewer" },
                        { title: "Seera App ", link: "/AppRole" },
                        { title: "Sagalee Karaa Tokko ", newTag: true, link: "/One-way-Audio" },
                        { title: "Gabaasa Hojii", link: "/Activity-Report" },
                    ],
                },
                {
                    title: "Nageenya Qabiyyeey",
                    bg: "#fff8e9",
                    features: [
                        { title: "YouTube To'annoo Warra", link: "/youtube-parental-controls" },
                        { title: "Seenaa TikTok", link: "/tiktok-history" },
                        { title: "Suuraa Hin Malle", link: "/detect-suspicious-text" },
                        { title: "Appii Hawaasaa Adda Baasuun", link: "/block-websites" },
                        { title: "Calaltuu Weebii", link: "/Web-Filter" },
                        { title: "Seenaa Browser", link: "/Browser-History" },
                    ],
                },
                {
                    title: "Tajaajila Bakka",
                    bg: "#f1ffef",
                    features: [
                        { title: "Bakka Hordoffii", link: "/Locaton-Tracking" },
                        { title: "Gabaasa Konkolaachisaa", link: "/Driving-Report" },
                        { title: "Akeekkachiisa SOS", newTag: true, link: "/Sos-Alart" },
                    ],
                },
            ],
            // End features Dropdown
            ...
            blogData: [
                {
                    title: "Hordoffii Bakka",
                    links: [
                        { label: "Hordoffii Moobaayilaa", href: "/Mobile-Tracking" },
                        { label: "Bakka Qoodamuu", href: "/Location-Sharing" },
                        { label: "Hordoffii Maatii", href: "/Family-Tracking" },
                        { label: "Dargaggoonni Konkolaachisuun", href: "/Teen-Driving" },
                    ],
                },
                {
                    title: "Yeroo Iskiriinii",
                    links: [
                        { label: "To'annoo Yeroo Iskiriinii", href: "/Screen-Time-Blogs" },
                        { label: "To'annoo Warra iOS", href: "/Ios-Parental-Controller" },
                        { label: "To'annoo Warra Android", href: "/Andriod-Parental-Controller" },
                        { label: "To'annoo Warra Desktop", href: "/DeskTop-Parental-Controller" },
                        { label: "To'annoo Chromebook", href: "/ChromeBook-Controller" },
                    ],
                },
                {
                    title: "App Blocker jedhu",
                    links: [
                        { label: "Taphoota Ugguraa", href: "/Block-Game" },
                        { label: "YouTube ugguraa", href: "/Block-Youtube" },
                        { label: "Appilikeeshiniiwwan Ugguraa", href: "/App-Blocks" },
                        { label: "Porno ugguruu", href: "/Block-Porn" },
                    ],
                },
                {
                    title: "Hordoffii Hojii",
                    links: [
                        { label: "Caalbaasii Weebii", href: "/Web-filtering" },
                        { label: "Hordoffii Bilbilaa", href: "/Phone-monitering" },
                        { label: "Saalqunnamtii Dargaggootaa", href: "/Teen-Sexing" },
                        { label: "Farra Bullying", href: "/Anti-Billing" },
                    ],
                },
                {
                    title: "Beekumsa Warra Ta'uu",
                    links: [
                        { label: "Parenting Tips", href: "/Parenting-Tips" },
                        { label: "Teen Slang", href: "/Teen-Slang" },
                        { label: "Trending Apps", href: "/Trainding-AppRivew" },
            ...
            resourceDropdownData: {
                featuredTopics: {
                    title: "Mata dureewwan Mul'ataman",
                    items: [
                        { label: "Yeroo Iskiriinii Madaallii", href: "/Screentime-For-Kids" },
                        { label: "Nageenya Daa'immanii Dijiitaalaa", href: "/Internet-Safty" },
                        { label: "Pornoota Ugguraa", href: "/Block-Porn" },
                        { label: "Saalqunnamtii (Sextortion) Dhaabuu", href: "/Compagin-Stops" },
                        { label: "Gocha Yaaddoo AI", href: "/Artifical-Intelligence" },
                        { label: "Cyberbullying dhiisaa", href: "/Stop-Cyberbullying" },
                        { label: "Saalqunnamtii Dargaggootaa", href: "/Teen-Sexting" },
                    ],
                },
    
                guide: {
                    title: "Qajeelfama FamiSafe",
                    items: [
                        { label: "Qajeelfama Fayyadamtootaa", href: "/User-Guide" },
                        { label: "Qajeelfama Fayyadamtootaa Mana Barumsaa", href: "/User-Guide-For-School" },
                        { label: "Qajeelfama Viidiyoo", href: "/Video-Guide" },
                        { label: "Gaaffii Fayyadamtootaa", href: "/User-FAQS" },
                    ],
                },
    
                explore: {
                    title: "Gadi fageenyaan ibsuu",
                    items: [
                        { label: "Waan Haaraa", href: "/What-is-News" },
                        { label: "Warri Irra Deebiin Irra Deebiin", href: "/Parental-Review" },
                        { label: "Duula Maqaa (Brand) jedhamuun beekama", href: "/Campaigns" },
                        { label: "Gamaaggama Miidiyaa", href: "/Midea-Reviw" },
                        { label: "Annual Report", href: "/Annual-Report" },
                        { label: "Seenaa Maatii", href: "/Family-Stories" },
                ...
                actions: {
                    downloadText: "Download App",
                    tryFreeText: "Torni Interneetii Bilisaa Yaali ☁️",
                    tryFreeLink: "#",
                },
            },
            // End RESPURCE DROPDOWN
            ...
            // footer translations end
            // {/*For School Page Translations*/}
            FamiSafeKeeps: "FamiSafe Bara Dijitaalaa Keessatti Barattoota Nageenya Isaanii Eega",
            MoniterProtect: "Hordoffii | Eegduu | Akeekkachiisuu",
            // for School
            cards: [
                {
                    title: "Yaada namaa jeequu",
                    desc: "Yeroo qorumsi meeshaalee dijitaalaa gosa hunda naannoo sana jiranitti barattoonni daree keessatti xiyyeeffachuun akka isaan rakkisu ni hubattu",
                    bg: "bg-[#E9F8FD]",
                    img: 'https://famisafe.wondershare.com/images/images-2021/website-2021/school-pic-1.png',
                },
                {
                    title: "Saayibarii irratti nama doorsisu",
                    desc: "Yeroo baayyee saayibarii bullying mooraa keessatti uuma. Taateewwan saayibarii irratti raawwataman yeroon hordofamuu yoo danda’an kasaaraan yeroon dhaabbachuu danda’a",
                    bg: "bg-[#FFF1EB]",
                    img: 'https://famisafe.wondershare.com/images/images-2021/website-2021/school-pic-2.png',
                },
                {
                    title: "Araada",
                    desc: "Diraamaa ilaaluuf, viidiyoo ilaaluu, tapha taphachuu... Araada interneetii kan qaban, jireenyi barattoonni hedduun amma qaban kana",
                    bg: "bg-[#F4F3FF]",
                    img: 'https://famisafe.wondershare.com/images/images-2021/website-2021/school-pic-3.png',
                },
                {
                    title: "Hatuu",
                    desc: "Bara dijitaalaa mijataa ta’e kana keessatti, saamichi barreeffamaa salphaa fi baay’inaan waan mul’ateef, barsiisonni qulqullina barumsaa fi carraa gowwoomsaa caalaatti yaadda’uun isaanii hin oolu",
                    bg: "bg-[#EFFFF9]",
                    img: 'https://famisafe.wondershare.com/images/images-2021/website-2021/school-pic-4.png',
                },
            ],
            Technologyinschool: "Teeknooloojiin mana barumsaa keessatti gargaara, garuu qormaata",
            FamiSafeprotectsall: "FamiSafe barattoota hunda karaa bu’a qabeessa ta’een ni eega",
            featuress: [
                {
                    title: "Calaltuu Weebii",
                    icon: ShieldCheck,
                    color: "bg-orange-500",
                    cardBg: "bg-[#FFF1EB]",
                    points: [
                        "Barbaacha Filter Weebsaayitiitiin Nageenya Qabu",
                        "Marsariitiiwwan gosa tokkoon ugguruu",
                        "Weebsaayitoota ala ta'an dabaluudhaan ugguruu ykn hayyamuu",
                    ],
                    pointColor: "bg-orange-500",
                },
                {
                    title: "Multi - Fayyadamaa, Hedduu - Meeshaa",
                    icon: Users,
                    color: "bg-purple-500",
                    cardBg: "bg-[#F4F3FF]",
                    points: [
                        "Filannoo maallaqa galchuu adda addaa kenni",
                        "Yeroo tokkotti barattoota hedduu bulchuu",
                        "Daataa itti fayyadama appii barattootaa ilaaluu fi walitti qabuu",
                    ],
                    pointColor: "bg-purple-500",
                },
                {
                    title: "Daashboordii Ismaartii",
                    icon: BarChart3,
                    color: "bg-emerald-400",
                    cardBg: "bg-[#EFFFF9]",
                    points: [
                        "Odeeffannoo barattootaa hunda walitti qabuu",
                        "Bulchiinsa tokkummaa meeshaalee barattootaa",
                        "Fayyadama meeshaalee har'aa barattootaa saffisaan ilaali",
                    ],
                    pointColor: "bg-emerald-400",
                },
            ],
            WhyisFamiSafe: "FamiSafe maaliif mana barumsaa keessaniif filannoo hundarra gaarii ta’e?",
            ScreenSupervision: "To’annoo Iskiriinii",
            Asphoneortablet: "Bilbilli ykn taableetiin qaama jireenya daa’immanii waan ta’eef, Barsiisonni barattoonni madaallii akka qabaatan gargaaruu, yaada isaanii jeequu ykn hirriba dhabuu qo’achuuf dhaabuu yaaduu qabu.",
            AppBlocker: "App Blocker jedhu",
            Studentsneedtofocus: "Barattoonni barumsa isaanii irratti xiyyeeffachuu qabu, garuu appilikeeshiniiwwan tokko tokko kan barumsaan wal hin qabanne yeroo hunda yaada barattootaa ni jeequ.",
            OnlineSafety: "Nageenya Toora Interneetii",
            Theonlineworld: "Addunyaa toora interneetii gammachiisaa fi hawwataa ta’us, balaawwan nageenyaa dhokataan kanneen akka saayibarii, poornoogiraafii fi saayibarii nama saaxilan ni jiru. Barattoonni qajeelfamaa fi gargaarsa barsiisota irraa barbaadu.",
            TheMostReliable: "App To'annoo Warraa Irra Amanamaadha",
            /// FAQs Section
            faqs: [
                {
                    question: "How to monitor text messages on a kid's phone?",
