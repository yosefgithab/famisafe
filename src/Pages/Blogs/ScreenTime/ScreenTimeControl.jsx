...
export default function ScreenTimeControl() {
  ...
  const { language } = useLanguage();
      const articlxdSes = language === "en" ? translations.en.articlxdSes : language === "am" ? translations.am.articlxdSes :language== "om" ? translations.om.articlxdSes: "";    
      const categories = language === "en" ? translations.en.categories : language === "am" ? translations.am.categories :language== "om" ? translations.om.categories: "";
          const articlebdSss = language === "en" ? translations.en.articlebdSss : language === "am" ? translations.am.articlebdSss :language== "om" ? translations.om.articlebdSss: "";
  ...
  return (
        ...
        <div className=" bg-gradient-to-r from-[#FEDFCF] via-[#FBCEF8] to-[#CDFEFE] rounded-lg max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p
              ...
              {language === "en"
                ? translations.en.Limitscreentimea
                : language === "am"
                  ? translations.am.Limitscreentimea
                  : language === "om"
                    ? translations.om.Limitscreentimea
                    : ""}
            </p>
          </div>
          <br />
    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <h2 className="text-center text-3xl font-bold mt-16">
        {language === "en" ? translations.en.AllScreenTimeControl : language === "am" ? translations.am.AllScreenTimeControl : language === "om" ? translations.om.AllScreenTimeControl: ""}
      </h2>
    </div>
    {/*========================= ==================================*/}
