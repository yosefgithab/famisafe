...
export default function IOSParentalControl() {
  const currentPage = 1;
  const totalPages = 5;
  const { language } = useLanguage();
      const AlliOSntalCorol = language === "en" ? translations.en.AlliOSntalCorol : language === "am" ? translations.am.AlliOSntalCorol :language== "om" ? translations.om.AlliOSntalCorol: "";    
      const categories = language === "en" ? translations.en.categories : language === "am" ? translations.am.categories :language== "om" ? translations.om.categories: "";
          const AlliOSPareontrol = language === "en" ? translations.en.AlliOSPareontrol : language === "am" ? translations.am.AlliOSPareontrol :language== "om" ? translations.om.AlliOSPareontrol: "";
  ...
  return (
        ...
        <div className=" bg-gradient-to-r from-[#FEDFCF] via-[#FBCEF8] to-[#CDFEFE] rounded-lg max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h3 className="text-lg sm:text-2xl md:text-3xl lg:text-3xl font-extrabold text-gray-900 leading-tight max-w-3xl sm:max-w-4xl mx-auto">
              ...
              {language === "en" ? translations.en.iOSParentalControl : language === "am" ? translations.am.iOSParentalControl : language == "om" ? translations.om.iOSParentalControl : ""}
            </h3>
            <br />
            ...
            <p
              ...
              {language === "en"
                ? translations.en.BestiOSParental
                : language === "am"
                  ? translations.am.BestiOSParental
                  : language === "om"
                    ? translations.om.BestiOSParental
                    : ""}
            </p>
          </div>
          <br />
    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        {AlliOSntalCorol.map((item, index) => (
          <div
            key={index}
      ...
      <h2 className="text-center text-3xl font-bold mt-16">
        {language === "en" ? translations.en.AlliOSParentalControl : language === "am" ? translations.am.AlliOSParentalControl : language === "om" ? translations.om.AlliOSParentalControl: ""}
      </h2>
    </div>
    {/*========================= ==================================*/}
    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <main className="lg:col-span-9 space-y-10">
          {AlliOSPareontrol.map((item, index) => (
