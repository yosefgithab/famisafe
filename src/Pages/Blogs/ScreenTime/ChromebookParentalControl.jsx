...
export default function ChromebookParentalControl() {
  const currentPage = 1;
  const totalPages = 5;
  const { language } = useLanguage();
      const Chromebo65okGuide = language === "en" ? translations.en.Chromebo65okGuide : language === "am" ? translations.am.Chromebo65okGuide :language== "om" ? translations.om.Chromebo65okGuide: "";    
      const categories = language === "en" ? translations.en.categories : language === "am" ? translations.am.categories :language== "om" ? translations.om.categories: "";
          const Chromebo66okGuide = language === "en" ? translations.en.Chromebo66okGuide : language === "am" ? translations.am.Chromebo66okGuide :language== "om" ? translations.om.Chromebo66okGuide: "";
  ...
  return (
        ...
        <div className=" bg-gradient-to-r from-[#FEDFCF] via-[#FBCEF8] to-[#CDFEFE] rounded-lg max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h3 className="text-lg sm:text-2xl md:text-3xl lg:text-3xl font-extrabold text-gray-900 leading-tight max-w-3xl sm:max-w-4xl mx-auto">
              ...
              {language === "en" ? translations.en.ChromebookGuide : language === "am" ? translations.am.ChromebookGuide : language == "om" ? translations.om.ChromebookGuide : ""}
            </h3>
            <br />
            ...
            <p
              ...
              {language === "en"
                ? translations.en.Hereyouanfin76
                : language === "am"
                  ? translations.am.Hereyouanfin76
                  : language === "om"
                    ? translations.om.Hereyouanfin76
                    : ""}
            </p>
          </div>
          <br />
    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        {Chromebo65okGuide.map((item, index) => (
          <div
            key={index}
      ...
      <h2 className="text-center text-3xl font-bold mt-16">
        {language === "en" ? translations.en.AllChromebookGuide : language === "am" ? translations.am.AllChromebookGuide : language === "om" ? translations.om.AllChromebookGuide: ""}
      </h2>
    </div>
    {/*========================= ==================================*/}
    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <main className="lg:col-span-9 space-y-10">
          {Chromebo66okGuide.map((item, index) => (
