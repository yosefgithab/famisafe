...
export default function AndroidParentalControl() {
  const currentPage = 1;
  const totalPages = 5;
  const { language } = useLanguage();
      const AndriodiOSntalCorol = language === "en" ? translations.en.AndriodiOSntalCorol : language === "am" ? translations.am.AndriodiOSntalCorol :language== "om" ? translations.om.AndriodiOSntalCorol: "";    
      const categories = language === "en" ? translations.en.categories : language === "am" ? translations.am.categories :language== "om" ? translations.om.categories: "";
          const AndriodiOSPareontrol = language === "en" ? translations.en.AndriodiOSPareontrol : language === "am" ? translations.am.AndriodiOSPareontrol :language== "om" ? translations.om.AndriodiOSPareontrol: "";
  ...
  return (
        ...
        <div className=" bg-gradient-to-r from-[#FEDFCF] via-[#FBCEF8] to-[#CDFEFE] rounded-lg max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h3 className="text-lg sm:text-2xl md:text-3xl lg:text-3xl font-extrabold text-gray-900 leading-tight max-w-3xl sm:max-w-4xl mx-auto">
              ...
              {language === "en" ? translations.en.AndroidParentalControl : language === "am" ? translations.am.AndroidParentalControl : language == "om" ? translations.om.AndroidParentalControl : ""}
            </h3>
            <br />
            ...
            <p
              ...
              {language === "en"
                ? translations.en.Inthistopicyouwi
                : language === "am"
                  ? translations.am.Inthistopicyouwi
                  : language === "om"
                    ? translations.om.Inthistopicyouwi
                    : ""}
            </p>
          </div>
          <br />
    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        {AndriodiOSntalCorol.map((item, index) => (
          <div
            key={index}
      ...
      <h2 className="text-center text-3xl font-bold mt-16">
        {language === "en" ? translations.en.AllAnroidaretalControl : language === "am" ? translations.am.AllAnroidaretalControl : language === "om" ? translations.om.AllAnroidaretalControl: ""}
      </h2>
    </div>
    {/*========================= ==================================*/}
