...
export default function TeenSexing() {
  const currentPage = 1;
  const totalPages = 5;
  const { language } = useLanguage();
      const TeenSexvftyuting = language === "en" ? translations.en.TeenSexvftyuting : language === "am" ? translations.am.TeenSexvftyuting :language== "om" ? translations.om.TeenSexvftyuting: "";    
      const categories = language === "en" ? translations.en.categories : language === "am" ? translations.am.categories :language== "om" ? translations.om.categories: "";
          const TeenSeiuhxting = language === "en" ? translations.en.TeenSeiuhxting : language === "am" ? translations.am.TeenSeiuhxting :language== "om" ? translations.om.TeenSeiuhxting: "";
  ...
  return (
        ...
        <div className=" bg-gradient-to-r from-[#FEDFCF] via-[#FBCEF8] to-[#CDFEFE] rounded-lg max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h3 className="text-lg sm:text-2xl md:text-3xl lg:text-3xl font-extrabold text-gray-900 leading-tight max-w-3xl sm:max-w-4xl mx-auto">
              ...
              {language === "en" ? translations.en.TeenSexting : language === "am" ? translations.am.TeenSexting : language == "om" ? translations.om.TeenSexting : ""}
            </h3>
            <br />
            ...
            <p
              ...
              {language === "en"
                ? translations.en.Sextingisanincreasi
                : language === "am"
                  ? translations.am.Sextingisanincreasi
                  : language === "om"
                    ? translations.om.Sextingisanincreasi
                    : ""}
            </p>
          </div>
          <br />
    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        {TeenSexvftyuting.map((item, index) => (
          <div
            key={index}
      ...
      <h2 className="text-center text-3xl font-bold mt-16">
        {language === "en" ? translations.en.AllTeenSexting : language === "am" ? translations.am.AllTeenSexting : language === "om" ? translations.om.AllTeenSexting: ""}
      </h2>
    </div>
    {/*========================= ==================================*/}
