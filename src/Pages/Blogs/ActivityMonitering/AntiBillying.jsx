...
export default function AntiBillying() {
  const currentPage = 1;
  const totalPages = 5;
  const { language } = useLanguage();
      const AntiBullyi655rfng = language === "en" ? translations.en.AntiBullyi655rfng : language === "am" ? translations.am.AntiBullyi655rfng :language== "om" ? translations.om.AntiBullyi655rfng: "";    
      const categories = language === "en" ? translations.en.categories : language === "am" ? translations.am.categories :language== "om" ? translations.om.categories: "";
          const AntiBullyi76tgbnng = language === "en" ? translations.en.AntiBullyi76tgbnng : language === "am" ? translations.am.AntiBullyi76tgbnng :language== "om" ? translations.om.AntiBullyi76tgbnng: "";
  ...
  return (
        ...
        <div className=" bg-gradient-to-r from-[#FEDFCF] via-[#FBCEF8] to-[#CDFEFE] rounded-lg max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h3 className="text-lg sm:text-2xl md:text-3xl lg:text-3xl font-extrabold text-gray-900 leading-tight max-w-3xl sm:max-w-4xl mx-auto">
              ...
              {language === "en" ? translations.en.AntiBullying : language === "am" ? translations.am.AntiBullying : language == "om" ? translations.om.AntiBullying : ""}
            </h3>
            <br />
            ...
            <p
              ...
              {language === "en"
                ? translations.en.Getautomaticalertso
                : language === "am"
                  ? translations.am.Getautomaticalertso
                  : language === "om"
                    ? translations.om.Getautomaticalertso
                    : ""}
            </p>
          </div>
          <br />
    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        {AntiBullyi655rfng.map((item, index) => (
          <div
            key={index}
      ...
      <h2 className="text-center text-3xl font-bold mt-16">
        {language === "en" ? translations.en.AllAntiBullying : language === "am" ? translations.am.AllAntiBullying : language === "om" ? translations.om.AllAntiBullying: ""}
      </h2>
    </div>
    {/*========================= ==================================*/}
    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <main className="lg:col-span-9 space-y-10">
          {AntiBullyi76tgbnng.map((item, index) => (
