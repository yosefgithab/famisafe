...
export default function BlockYoutube() {
  ...
  const { language } = useLanguage();
      const PhoneMonitoringggfgd54 = language === "en" ? translations.en.PhoneMonitoringggfgd54 : language === "am" ? translations.am.PhoneMonitoringggfgd54 :language== "om" ? translations.om.PhoneMonitoringggfgd54: "";    
      const categories = language === "en" ? translations.en.categories : language === "am" ? translations.am.categories :language== "om" ? translations.om.categories: "";
          const PhoneMonitoring423d = language === "en" ? translations.en.PhoneMonitoring423d : language === "am" ? translations.am.PhoneMonitoring423d :language== "om" ? translations.om.PhoneMonitoring423d: "";
  ...
  return (
        ...
        <div className=" bg-gradient-to-r from-[#FEDFCF] via-[#FBCEF8] to-[#CDFEFE] rounded-lg max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h3 className="text-lg sm:text-2xl md:text-3xl lg:text-3xl font-extrabold text-gray-900 leading-tight max-w-3xl sm:max-w-4xl mx-auto">
              ...
              {language === "en" ? translations.en.PhoneMonitoring : language === "am" ? translations.am.PhoneMonitoring : language == "om" ? translations.om.PhoneMonitoring : ""}
            </h3>
            <br />
            ...
            <p
              ...
              {language === "en"
                ? translations.en.Learnhowtosetuppa
                : language === "am"
                  ? translations.am.Learnhowtosetuppa
                  : language === "om"
                    ? translations.om.Learnhowtosetuppa
                    : ""}
            </p>
          </div>
          <br />
    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        {PhoneMonitoringggfgd54.map((item, index) => (
          <div
            key={index}
      ...
      <h2 className="text-center text-3xl font-bold mt-16">
        {language === "en" ? translations.en.AllPhoneMonitoring : language === "am" ? translations.am.AllPhoneMonitoring : language === "om" ? translations.om.AllPhoneMonitoring: ""}
      </h2>
    </div>
    {/*========================= ==================================*/}
    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <main className="lg:col-span-9 space-y-10">
          {PhoneMonitoring423d.map((item, index) => (
