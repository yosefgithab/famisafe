...
export default function WebFiltering() {
  ...
  const WebFiltering54df = language === "en" ? translations.en.WebFiltering54df : language === "am" ? translations.am.WebFiltering54df : language == "om" ? translations.om.WebFiltering54df : "";
  ...
  const WebFil76gfrtering = language === "en" ? translations.en.WebFil76gfrtering : language === "am" ? translations.am.WebFil76gfrtering : language == "om" ? translations.om.WebFil76gfrtering : "";
      ...
      <div className="max-w-7xl mx-auto  mr-6 ml-6  mb-6">
        ...
        <div className=" bg-gradient-to-r from-[#FEDFCF] via-[#FBCEF8] to-[#CDFEFE] rounded-lg max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h3 className="text-lg sm:text-2xl md:text-3xl lg:text-3xl font-extrabold text-gray-900 leading-tight max-w-3xl sm:max-w-4xl mx-auto">
              ...
              {language === "en" ? translations.en.WebFiltering : language === "am" ? translations.am.WebFiltering : language == "om" ? translations.om.WebFiltering : ""}
            </h3>
            <br />
            ...
            <p
              ...
              {language === "en"
                ? translations.en.BestInternetContentFil
                : language === "am"
                  ? translations.am.BestInternetContentFil
                  : language === "om"
                    ? translations.om.BestInternetContentFil
                    : ""}
            </p>
          </div>
          <br />
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {WebFiltering54df.map((item, index) => (
              <div
                key={index}
          ...
          <h2 className="text-center text-3xl font-bold mt-16">
            {language === "en" ? translations.en.AllWebFiltering : language === "am" ? translations.am.AllWebFiltering : language === "om" ? translations.om.AllWebFiltering : ""}
          </h2>
        </div>
        {/*========================= ==================================*/}
        ...
        <div className="max-w-7xl mx-auto px-4 py-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <main className="lg:col-span-9 space-y-10">
              {WebFil76gfrtering.map((item, index) => (
