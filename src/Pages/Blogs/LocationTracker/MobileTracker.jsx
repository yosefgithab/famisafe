...
export default function MobileTracker() {
  ...
  const { language } = useLanguage();
      const articlDdSes = language === "en" ? translations.en.articlDdSes : language === "am" ? translations.am.articlDdSes :language== "om" ? translations.om.articlDdSes: "";    
      const categories = language === "en" ? translations.en.categories : language === "am" ? translations.am.categories :language== "om" ? translations.om.categories: "";
          const articleSdSss = language === "en" ? translations.en.articleSdSss : language === "am" ? translations.am.articleSdSss :language== "om" ? translations.om.articleSdSss: "";
  ...
  return (
        ...
        <div className=" bg-gradient-to-r from-[#FEDFCF] via-[#FBCEF8] to-[#CDFEFE] rounded-lg max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h3 className="text-lg sm:text-2xl md:text-3xl lg:text-3xl font-extrabold text-gray-900 leading-tight max-w-3xl sm:max-w-4xl mx-auto">
              ...
              {language === "en" ? translations.en.MobileTracker : language === "am" ? translations.am.MobileTracker : language == "om" ? translations.om.MobileTracker : ""}
            </h3>
            <br />
            ...
            <p
              ...
              {language === "en"
                ? translations.en.Readourblogsabo
                : language === "am"
                  ? translations.am.Readourblogsabo
                  : language === "om"
                    ? translations.om.Readourblogsabo
                    : ""}
            </p>
          </div>
          <br />
    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <h2 className="text-center text-3xl font-bold mt-16">
        {language === "en" ? translations.en.AllMobileTracker : language === "am" ? translations.am.AllMobileTracker : language === "om" ? translations.om.AllMobileTracker: ""}
      </h2>
    </div>
    {/*========================= ==================================*/}
