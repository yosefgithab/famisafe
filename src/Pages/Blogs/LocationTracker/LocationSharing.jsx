...
export default function LocationSharing() {
  ...
  const { language } = useLanguage();
    ...
    const articles = language === "en" ? translations.en.articles : language === "am" ? translations.am.articles :language== "om" ? translations.om.articles: "";    
    const categories = language === "en" ? translations.en.categories : language === "am" ? translations.am.categories :language== "om" ? translations.om.categories: "";
        const articless = language === "en" ? translations.en.articless : language === "am" ? translations.am.articless :language== "om" ? translations.om.articless: "";
        ...
        <div className=" bg-gradient-to-r from-[#FEDFCF] via-[#FBCEF8] to-[#CDFEFE] rounded-lg max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h3 className="text-lg sm:text-2xl md:text-3xl lg:text-3xl font-extrabold text-gray-900 leading-tight max-w-3xl sm:max-w-4xl mx-auto">
              ...
              {language === "en" ? translations.en.KnowMorAboutDis : language === "am" ? translations.am.KnowMorAboutDis : language == "om" ? translations.or.KnowMorAboutDis : ""}
            </h3>
            <br />
            ...
            <p
              ...
              {language === "en"
                ? translations.en.Leavedigitalparen
                : language === "am"
                  ? translations.am.Leavedigitalparen
                  : language === "om"
                    ? translations.or.Leavedigitalparen
                    : ""}
            </p>
          </div>
          <br />
