...
export default function FamilyTracking() {
  ...
  const { language } = useLanguage();
      const articlDSes = language === "en" ? translations.en.articlDSes : language === "am" ? translations.am.articlDSes :language== "om" ? translations.om.articlDSes: "";    
      const categories = language === "en" ? translations.en.categories : language === "am" ? translations.am.categories :language== "om" ? translations.om.categories: "";
          const articleSSss = language === "en" ? translations.en.articleSSss : language === "am" ? translations.am.articleSSss :language== "om" ? translations.om.articleSSss: "";
  ...
  return (
        ...
        <div className=" bg-gradient-to-r from-[#FEDFCF] via-[#FBCEF8] to-[#CDFEFE] rounded-lg max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h3 className="text-lg sm:text-2xl md:text-3xl lg:text-3xl font-extrabold text-gray-900 leading-tight max-w-3xl sm:max-w-4xl mx-auto">
              ...
              {language === "en" ? translations.en.FamilyTracker : language === "am" ? translations.am.FamilyTracker : language == "om" ? translations.om.FamilyTracker : ""}
            </h3>
            <br />
            ...
            <p
              ...
              {language === "en"
                ? translations.en.Whatsthebes
                : language === "am"
                  ? translations.am.Whatsthebes
                  : language === "om"
                    ? translations.om.Whatsthebes
                    : ""}
            </p>
          </div>
          <br />
    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <h2 className="text-center text-3xl font-bold mt-16">
         {language === "en"
                ? translations.en.AllFamilyTracker
                : language === "am"
                  ? translations.am.AllFamilyTracker
                  : language === "om"
                    ? translations.om.AllFamilyTracker
                    : ""}
      </h2>
    </div>
    {/*========================= ==================================*/}
