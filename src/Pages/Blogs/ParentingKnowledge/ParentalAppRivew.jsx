...
export default function ParentalAppRivew() {
  const currentPage = 1;
  const totalPages = 5;
  const { language } = useLanguage();
  const ParentalAppReview654f = language === "en" ? translations.en.ParentalAppReview654f : language === "am" ? translations.am.ParentalAppReview654f : language == "om" ? translations.om.ParentalAppReview654f : "";
  ...
  const ParentalAppReview878h = language === "en" ? translations.en.ParentalAppReview878h : language === "am" ? translations.am.ParentalAppReview878h : language == "om" ? translations.om.ParentalAppReview878h : "";
      ...
      <div className="max-w-7xl mx-auto  mr-6 ml-6  mb-6">
        ...
        <div className=" bg-gradient-to-r from-[#FEDFCF] via-[#FBCEF8] to-[#CDFEFE] rounded-lg max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h3 className="text-lg sm:text-2xl md:text-3xl lg:text-3xl font-extrabold text-gray-900 leading-tight max-w-3xl sm:max-w-4xl mx-auto">
              ...
              {language === "en" ? translations.en.ParentalAppReview : language === "am" ? translations.am.ParentalAppReview : language == "om" ? translations.om.ParentalAppReview : ""}
            </h3>
            <br />
            ...
            <p
              ...
              {language === "en"
                ? translations.en.Therearevariousofpar
                : language === "am"
                  ? translations.am.Therearevariousofpar
                  : language === "om"
                    ? translations.om.Therearevariousofpar
                    : ""}
            </p>
          </div>
          <br />
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {ParentalAppReview654f.map((item, index) => (
              <div
                key={index}
          ...
          <h2 className="text-center text-3xl font-bold mt-16">
            {language === "en" ? translations.en.AllParentalAppReview : language === "am" ? translations.am.AllParentalAppReview : language === "om" ? translations.om.AllParentalAppReview : ""}
          </h2>
        </div>
        {/*========================= ==================================*/}
        ...
        <div className="max-w-7xl mx-auto px-4 py-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <main className="lg:col-span-9 space-y-10">
              {ParentalAppReview878h.map((item, index) => (
