...
export default function TrindingAppRivew() {
  const currentPage = 1;
  const totalPages = 5;
  const { language } = useLanguage();
  const TrendingAppReview765G = language === "en" ? translations.en.TrendingAppReview765G : language === "am" ? translations.am.TrendingAppReview765G : language == "om" ? translations.om.TrendingAppReview765G : "";
  ...
  const TrendingAppReviewWSDDE43 = language === "en" ? translations.en.TrendingAppReviewWSDDE43 : language === "am" ? translations.am.TrendingAppReviewWSDDE43 : language == "om" ? translations.om.TrendingAppReviewWSDDE43 : "";
      ...
      <div className="max-w-7xl mx-auto  mr-6 ml-6  mb-6">
        ...
        <div className=" bg-gradient-to-r from-[#FEDFCF] via-[#FBCEF8] to-[#CDFEFE] rounded-lg max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h3 className="text-lg sm:text-2xl md:text-3xl lg:text-3xl font-extrabold text-gray-900 leading-tight max-w-3xl sm:max-w-4xl mx-auto">
              ...
              {language === "en" ? translations.en.TrendingAppReview : language === "am" ? translations.am.TrendingAppReview : language == "om" ? translations.om.TrendingAppReview : ""}
            </h3>
            <br />
            ...
            <p
              ...
              {language === "en"
                ? translations.en.FamiSafehelpspare
                : language === "am"
                  ? translations.am.FamiSafehelpspare
                  : language === "om"
                    ? translations.om.FamiSafehelpspare
                    : ""}
            </p>
          </div>
          <br />
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {TrendingAppReview765G.map((item, index) => (
              <div
                key={index}
          ...
          <h2 className="text-center text-3xl font-bold mt-16">
            {language === "en" ? translations.en.AllTrendingAppReview : language === "am" ? translations.am.AllTrendingAppReview : language === "om" ? translations.om.AllTrendingAppReview : ""}
          </h2>
        </div>
        {/*========================= ==================================*/}
        ...
        <div className="max-w-7xl mx-auto px-4 py-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <main className="lg:col-span-9 space-y-10">
              {TrendingAppReviewWSDDE43.map((item, index) => (
