...
export default function BlockGame() {
  ...
  const { language } = useLanguage();
      const Chromebo5j5okGuide = language === "en" ? translations.en.Chromebo5j5okGuide : language === "am" ? translations.am.Chromebo5j5okGuide :language== "om" ? translations.om.Chromebo5j5okGuide: "";    
      const categories = language === "en" ? translations.en.categories : language === "am" ? translations.am.categories :language== "om" ? translations.om.categories: "";
          const Chromebo5j6okGuide = language === "en" ? translations.en.Chromebo5j6okGuide : language === "am" ? translations.am.Chromebo5j6okGuide :language== "om" ? translations.om.Chromebo5j6okGuide: "";
  ...
  return (
        ...
        <div className=" bg-gradient-to-r from-[#FEDFCF] via-[#FBCEF8] to-[#CDFEFE] rounded-lg max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h3 className="text-lg sm:text-2xl md:text-3xl lg:text-3xl font-extrabold text-gray-900 leading-tight max-w-3xl sm:max-w-4xl mx-auto">
              ...
              {language === "en" ? translations.en.BlockGame : language === "am" ? translations.am.BlockGame : language == "om" ? translations.om.BlockGame : ""}
            </h3>
            <br />
            ...
            <p
              ...
              {language === "en"
                ? translations.en.Learnft6howto
                : language === "am"
                  ? translations.am.Learnft6howto
                  : language === "om"
                    ? translations.om.Learnft6howto
                    : ""}
            </p>
          </div>
          <br />
    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        {Chromebo5j5okGuide.map((item, index) => (
          <div
            key={index}
      ...
      <h2 className="text-center text-3xl font-bold mt-16">
        {language === "en" ? translations.en.AllBlockGames : language === "am" ? translations.am.AllBlockGames : language === "om" ? translations.om.AllBlockGames: ""}
      </h2>
    </div>
    {/*========================= ==================================*/}
    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <main className="lg:col-span-9 space-y-10">
          {Chromebo5j6okGuide.map((item, index) => (
