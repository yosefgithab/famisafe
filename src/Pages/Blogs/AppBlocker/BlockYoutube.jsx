...
export default function BlockYoutube() {
  ...
  const { language } = useLanguage();
      const BlockouTube6543 = language === "en" ? translations.en.BlockouTube6543 : language === "am" ? translations.am.BlockouTube6543 :language== "om" ? translations.om.BlockouTube6543: "";    
      const categories = language === "en" ? translations.en.categories : language === "am" ? translations.am.categories :language== "om" ? translations.om.categories: "";
          const BlockouTube0987 = language === "en" ? translations.en.BlockouTube0987 : language === "am" ? translations.am.BlockouTube0987 :language== "om" ? translations.om.BlockouTube0987: "";
  ...
  return (
        ...
        <div className=" bg-gradient-to-r from-[#FEDFCF] via-[#FBCEF8] to-[#CDFEFE] rounded-lg max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h3 className="text-lg sm:text-2xl md:text-3xl lg:text-3xl font-extrabold text-gray-900 leading-tight max-w-3xl sm:max-w-4xl mx-auto">
              ...
              {language === "en" ? translations.en.BlockouTube : language === "am" ? translations.am.BlockouTube : language == "om" ? translations.om.BlockouTube : ""}
            </h3>
            <br />
            ...
            <p
              ...
              {language === "en"
                ? translations.en.Worryingaboutwhatyou
                : language === "am"
                  ? translations.am.Worryingaboutwhatyou
                  : language === "om"
                    ? translations.om.Worryingaboutwhatyou
                    : ""}
            </p>
          </div>
          <br />
    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        {BlockouTube6543.map((item, index) => (
          <div
            key={index}
      ...
      <h2 className="text-center text-3xl font-bold mt-16">
        {language === "en" ? translations.en.AllBlockYouTube : language === "am" ? translations.am.AllBlockYouTube : language === "om" ? translations.om.AllBlockYouTube: ""}
      </h2>
    </div>
    {/*========================= ==================================*/}
    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <main className="lg:col-span-9 space-y-10">
          {BlockouTube0987.map((item, index) => (
