...
export default function LocationTraking() {
    ...
    const faqsSscreenviwer = language === "en" ? translations.en.faqsSscreenviwer : language === "am" ? translations.am.faqsSscreenviwer : language == "om" ? translations.om.faqsSscreenviwer : "";
        ...
        <section className=" w-full overflow-hidden px-4 sm:px-6 lg:px-0 py-2">
            <div className="bg-gradient-to-r from-[#E9FCF9] to-[#FFF9EE] max-w-7xl mx-auto 
                ...
                <div className="max-w-xl mx-auto text-center lg:text-left">
                    ...
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold leading-tight mb-4 sm:mb-6">
                        <span className="text-gray-700 px-2 py-1 rounded-lg inline-block">
                            {language === "en" ? translations.en.LocationTracking : language === "am" ? translations.am.LocationTracking : language == "om" ? translations.om.LocationTracking : ""}
                        </span>
                    </h1>

                    <p className="text-gray-700 text-sm sm:text-base lg:text-lg leading-6 sm:leading-7 mb-6 sm:mb-10">
                        {language === "en" ? translations.en.Trackkidsinrealt : language === "am" ? translations.am.Trackkidsinrealt : language == "om" ? translations.om.Trackkidsinrealt : ""}
                    </p>
                ...
                <div className="w-full flex justify-center mt-6 sm:mt-10 lg:mt-0">
                    <img
                        src="https://famisafe.wondershare.com/images/fs6/live-location/banner.png"
            ...
            <div className=" bg-white py-10 sm:py-12 max-w-6xl mx-auto px-4 lg:px-6 flex justify-center">
                ...
                "
                >
                    {language === "en" ? translations.en.RestEasywithReal : language === "am" ? translations.am.RestEasywithReal : language == "om" ? translations.om.RestEasywithReal: ""}
                </h3>
            </div>
            <br />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 sm:gap-12 lg:gap-16 items-center">
                    ...
                    <div className="lg:col-span-2 text-center lg:text-left max-w-xl sm:max-w-2xl mx-auto lg:mx-0">
                        ...
                        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold mb-4 sm:mb-6 text-gray-800 leading-tight">
                            {language === "en"
                                ? translations.en.ViewKidsRealT
                                : language === "am"
                                    ? translations.am.ViewKidsRealT
                                    : language === "om"
                                        ? translations.om.ViewKidsRealT
                                        : ""}
                        </h2>
                        ...
                        <ul className="list-disc list-inside space-y-2 sm:space-y-3 text-gray-600 text-sm sm:text-base">
                            <li>{language === "en" ? translations.en.Trackthecurrentloc : language === "am" ? translations.am.Trackthecurrentloc : language === "om"
                                ? translations.om.Trackthecurrentloc
                                : ""}</li>
                            <li> {language === "en" ? translations.en.Graspyourkidsrealti : language === "am" ? translations.am.Graspyourkidsrealti : language === "om"
                                ? translations.om.Graspyourkidsrealti
                                : ""}</li>
                            <li>{language === "en" ? translations.en.Checkifyourkidsar : language === "am" ? translations.am.Checkifyourkidsar : language === "om"
                                ? translations.om.Checkifyourkidsar
                                : ""}</li>
                            <li>{language === "en" ? translations.en.Involveintimewhe : language === "am" ? translations.am.Involveintimewhe : language === "om"
                                ? translations.om.Involveintimewhe
                                : ""}</li>
                        </ul>
            ...
            <div className="bg-white py-20 max-w-6xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16 items-center">
                ...
                <div className="lg:col-span-2 order-2 lg:order-1 text-center lg:text-left max-w-xl mx-auto lg:mx-0">
                    <h2 className="text-3xl sm:text-4xl font-extrabold mb-6 text-gray-800">
                        <li>{language === "en" ? translations.en.CheckLocatio : language === "am" ? translations.am.CheckLocatio : language == "om" ? translations.om.CheckLocatio : ""}</li>
                    </h2>

                    <p className="text-gray-700 text-base sm:text-lg leading-7 mb-6">
                        {language === "en" ? translations.en.Viewlocationhist : language === "am" ? translations.am.Viewlocationhist : language == "om" ? translations.om.Viewlocationhist : ""}
                    </p>
                    ...
                    <ul className="list-disc list-inside space-y-0 text-gray-600 text-sm sm:text-base">
                        ...
                        <li> {language === "en" ? translations.en.Knowkids : language === "am" ? translations.am.Knowkids : language == "om" ? translations.om.Knowkids : ""}</li>
                        <li> {language === "en" ? translations.en.Learnabout : language === "am" ? translations.am.Learnabout : language == "om" ? translations.om.Learnabout : ""}</li>
                    </ul>
                </div>
            ...
            <div className="bg-white py-20 max-w-6xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16 items-center">
                ...
                <div className="lg:col-span-2 text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
                    <h2 className="text-3xl sm:text-4xl font-extrabold mb-6 text-gray-800">
                        {language === "en" ? translations.en.SetSafeGeofen : language === "am" ? translations.am.SetSafeGeofen : language == "om" ? translations.om.SetSafeGeofen : ""}
                    </h2>

                    <p className="text-gray-700 text-base sm:text-lg leading-4 mb-6">
                        {language === "en" ? translations.en.CreateGeofenceslik : language === "am" ? translations.am.CreateGeofenceslik : language == "om" ? translations.om.CreateGeofenceslik : ""}
                    </p>

                    <ul className="list-disc list-inside space-y-0 text-gray-600 text-sm sm:text-basise">
                        <li>{language === "en" ? translations.en.Setthescopeo : language === "am" ? translations.am.Setthescopeo : language == "om" ? translations.om.Setthescopeo : ""}</li>
                        <li>{language === "en" ? translations.en.Setupgeofen : language === "am" ? translations.am.Setupgeofen : language == "om" ? translations.om.Setupgeofen : ""}</li>
                        <li>{language === "en" ? translations.en.Receiveanalertwh : language === "am" ? translations.am.Receiveanalertwh : language == "om" ? translations.om.Receiveanalertwh : ""}</li>
                    </ul>
                </div>
            ...
            <div className="border bg-[#EFFFFB] max-w-7xl mx-auto py-16 lg:py-20 rounded-lg  ml-4">
      ...
      "
            ...
            <div className="border mx-auto max-w-6xl rounded-3xl bg-[#F6F1FF] px-6 py-14 md:px-16 md:py-20">
                ...
                <h2 className="mb-12 text-center text-2xl font-semibold text-black md:text-3xl">
                    {language === "en" ? translations.en.MoreTipsforLoca : language === "am" ? translations.am.MoreTipsforLoca : language == "om" ? translations.om.MoreTipsforLoca : ""}
                </h2>
                    ...
                    <ul className="space-y-5 text-base text-black md:text-lg">
                        <li className="flex items-start gap-3">
                            ...
                            <a href="/best-screen-viewer-apps" className="hover:underline">
                                {language === "en"
                                    ? translations.en.BestFamilyLocat
                                    : language === "am"
                                        ? translations.am.BestFamilyLocat
                                        : language == "om"
                                            ? translations.om.BestFamilyLocat
                                            : ""}
                            </a>
                        </li>
                        ...
                        <li className="flex items-start gap-3">
                            ...
                            <a href="/free-screen-share-app" className="hover:underline">
                                {language === "en"
                                    ? translations.en.HowtoTracka
                                    : language === "am"
                                        ? translations.am.HowtoTracka
                                        : language == "om"
                                            ? translations.om.HowtoTracka
                                            : ""}
                            </a>
                        </li>
                        ...
                        <li className="flex items-start gap-3">
                            ...
                            <a href="/bypass-google-family-link" className="hover:underline">
                                {language === "en"
                                    ? translations.en.FreeAppstoT
                                    : language === "am"
                                        ? translations.am.FreeAppstoT
                                        : language == "om"
                                            ? translations.om.FreeAppstoT
                                            : ""}
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul className="space-y-5 text-base text-black md:text-lg">
                        <li className="flex items-start gap-3">
                            ...
                            <a href="/install-youtube-kids-amazon-fire" className="hover:underline">
                                {language === "en"
                                    ? translations.en.HowtoCheckImPhone
                                    : language === "am"
                                        ? translations.am.HowtoCheckImPhone
                                        : language == "om"
                                            ? translations.om.HowtoCheckImPhone
                                            : ""}
                            </a>
                        </li>
                        ...
                        <li className="flex items-start gap-3">
                            ...
                            <a href="/private-screenshot-apps" className="hover:underline">
                                {language === "en"
                                    ? translations.en.HowtoTrackYourki
                                    : language === "am"
                                        ? translations.am.HowtoTrackYourki
                                        : language == "om"
                                            ? translations.om.HowtoTrackYourki
                                            : ""}
                            </a>
                        </li>
                        ...
                        <li className="flex items-start gap-3">
                            ...
                            <a href="/family-link-not-working" className="hover:underline">
                                {language === "en"
                                    ? translations.en.HowtoTrackaPhone
                                    : language === "am"
                                        ? translations.am.HowtoTrackaPhone
                                        : language == "om"
                                            ? translations.om.HowtoTrackaPhone
                                            : ""}
                            </a>
                        </li>
                    </ul>
            ...
            <div className="mx-auto max-w-4xl">
                ...
                <div className="divide-y divide-gray-200">
                    {faqsSscreenviwer.map((faq, index) => (
