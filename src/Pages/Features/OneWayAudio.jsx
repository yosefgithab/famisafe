...
export default function OneWayAudio() {
    ...
    const tools = language === "en" ? translations.en.tools : language === "am" ? translations.am.tools : translations.om.tools;
    const faqsq = language === "en" ? translations.en.faqsq : language === "am" ? translations.am.faqsq : language == "om" ? translations.om.faqsq : "";
            ...
            <div className="max-w-7xl mx-auto">
                ...
                items-center overflow-hidden rounded-lg py-16 sm:py-20">
                    ...
                    <div className="max-w-xl mx-auto text-center lg:text-left">
                        ...
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold leading-tight mb-4 sm:mb-6">
                            <span className="text-gray-700 px-2 py-1 rounded-lg inline-block">
                                {language === "en" ? translations.en.OneWayAudio : language === "am" ? translations.am.OneWayAudio : language == "0m" ? translations.om.OneWayAudio : ""}
                            </span>
                        </h1>

                        <p className="text-gray-700 text-sm sm:text-base lg:text-lg leading-6 sm:leading-7 mb-6 sm:mb-10">
                            {language === "en" ? translations.en.Experiencetheultimate : language === "am" ? translations.am.Experiencetheultimate : language === "om" ? translations.om.Experiencetheultimate: ""}
                        </p>
                    ...
                    <div className="w-full flex justify-center mt-6 sm:mt-10 lg:mt-0">
                        <img
                            src="https://famisafe.wondershare.com/images/fs6/one-way-audio/banner-1.png"
                ...
                <div className="border bg-white py-10 sm:py-12 max-w-6xl mx-auto px-4 lg:px-6 flex justify-center">
                    <h3
                        className="
    ...
    "
                    >
                        {language === "en" ? translations.en.KeepTrackofYourChild : language === "am" ? translations.am.KeepTrackofYourChild : language == "om" ? translations.om.KeepTrackofYourChild : ""}
                    </h3>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 sm:gap-12 lg:gap-16 items-center">
                        ...
                        <div className="lg:col-span-1 flex justify-center lg:justify-start">
                            <div className="w-[160px] sm:w-[220px] md:w-[260px] lg:w-[320px]">
                                <img
                                    src="https://famisafe.wondershare.com/images/fs6/one-way-audio/con1.png"
                                    alt="Call & Messages"
                        ...
                        <div className="lg:col-span-2 text-center lg:text-left max-w-xl sm:max-w-2xl mx-auto lg:mx-0">
                            ...
                            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold mb-4 sm:mb-6 text-gray-800 leading-tight">
                                {language === "en" ? translations.en.GetRealTimeScreenshots : language === "am" ? translations.am.GetRealTimeScreenshots : language == "om" ? translations.om.GetRealTimeScreenshots : ""}
                            </h2>

                            <p className="text-gray-700 text-sm sm:text-base lg:text-lg leading-6 sm:leading-7 mb-5 sm:mb-6">
                                {language === "en" ? translations.en.FamiSafeScreenVieweris : language === "am" ? translations.am.FamiSafeScreenVieweris : language == "om" ? translations.om.FamiSafeScreenVieweris : ""}
                            </p>

                            <ul className="list-disc list-inside space-y-2 sm:space-y-3 text-gray-600 text-sm sm:text-base">
                                <li>{language === "en" ? translations.en.Getnstantscreenshots : language === "am" ? translations.am.Getnstantscreenshots : language == "om" ? translations.om.Getnstantscreenshots : ""}</li>
                                <li> {language === "en" ? translations.en.Monitorchildrens : language === "am" ? translations.am.Monitorchildrens : language == "om" ? translations.om.Monitorchildrens : ""}</li>
                                <li>{language === "en" ? translations.en.Seizethemomentsand : language === "am" ? translations.am.Seizethemomentsand : language == "om" ? translations.om.Seizethemomentsand : ""}</li>
                            </ul>
                ...
                <div className="bg-white py-20 max-w-6xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="lg:col-span-2 order-2 lg:order-1 text-center lg:text-left max-w-xl mx-auto lg:mx-0">
                        <h2 className="text-3xl sm:text-4xl font-extrabold mb-6 text-gray-800">
                            <li>{language === "en" ? translations.en.PreventPotentially : language === "am" ? translations.am.PreventPotentially : translations.om.PreventPotentially}</li>
                        </h2>

                        <p className="text-gray-700 text-base sm:text-lg leading-7 mb-6">
                            {language === "en" ? translations.en.Enhancechildsafetyand : language === "am" ? translations.am.Enhancechildsafetyand : language == "om" ? translations.om.Enhancechildsafetyand : ""}
                        </p>

                        <ul className="list-disc list-inside space-y-0 text-gray-600 text-sm sm:text-base">
                            <li> {language === "en" ? translations.en.Parentscanuicklylisten : language === "am" ? translations.am.Parentscanuicklylisten : language == "om" ? translations.om.Parentscanuicklylisten : ""}</li>
                            <li> {language === "en" ? translations.en.OneWayudiosafeguardschildren : language === "am" ? translations.am.OneWayudiosafeguardschildren : language == "om" ? translations.om.OneWayudiosafeguardschildren : ""}</li>
                            <li> {language === "en" ? translations.en.Ournewfeaturtrengthensarent : language === "am" ? translations.am.Ournewfeaturtrengthensarent : language == "om" ? translations.om.Ournewfeaturtrengthensarent : ""}</li>
                        </ul>
                    </div>
                    ...
                    <div className="lg:col-span-1 order-1 lg:order-2 relative flex justify-center lg:justify-end">
                        <div className="relative w-[260px] sm:w-[320px] lg:w-[380px]">
                            <img
                                src="https://famisafe.wondershare.com/images/fs6/one-way-audio/con2.png"
                                alt="Call & Messages"
            ...
            <div className="bg-[#EFFFFB] max-w-auto mx-auto py-16 lg:py-20 rounded-lg">

                {/* TITLE */}
                <h2 className="text-center text-2xl sm:text-3xl lg:text-4xl font-extrabold text-gray-900 mb-12">
                    {language === "en" ? translations.en.Howtoistentoid : language === "am" ? translations.am.Howtoistentoid : language == "om" ? translations.om.Howtoistentoid : ""}
                </h2>
                ...
                <div className="mt-16 text-center">
                    ...
                    <div className="border flex flex-col sm:flex-row flex-wrap justify-center gap-4 ">
                        {appStores.map((store) => (
                            <a
                                key={store.name}
                                href={store.href}
          ...
          shadow-sm group-hover:shadow-lg"
            ...
            <div className="mx-auto max-w-6xl rounded-3xl bg-[#F6F1FF] px-6 py-14 md:px-16 md:py-20">
                ...
                <h2 className="mb-12 text-center text-2xl font-semibold text-black md:text-3xl">
                    {language === "en"
                        ? translations.en.MoreTipsabout
                        : language === "am"
                            ? translations.am.MoreTipsabout
                            : language == "om" ? translations.om.MoreTipsabout : ""}
                </h2>
                ...
                <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
                    ...
                    <ul className="space-y-5 text-base md:text-lg">
                        <li className="flex items-start gap-3">
                            ...
                            <a href="#" className="text-black hover:underline">
                                {language === "en"
                                    ? translations.en.WhatIsLive
                                    : language === "am"
                                        ? translations.am.WhatIsLive
                                        : language == "om" ? translations.om.WhatIsLive : ""}
                            </a>
                        </li>
                        ...
                        <li className="flex items-start gap-3">
                            ...
                            <a href="#" className="text-black hover:underline">
                                {language === "en"
                                    ? translations.en.Best5Android
                                    : language === "am"
                                        ? translations.am.Best5Android
                                        : language == "om" ? translations.om.Best5Android : ""}
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul className="space-y-5 text-base md:text-lg">
                        <li className="flex items-start gap-3">
                            ...
                            <a href="#" className="text-black hover:underline">
                                {language === "en"
                                    ? translations.en.WhySomeoneIs
                                    : language === "am"
                                        ? translations.am.WhySomeoneIs
                                        : language == "om" ? translations.om.WhySomeoneIs : ""}
                            </a>
                        </li>
                        ...
                        <li className="flex items-start gap-3">
                            ...
                            <a href="#" className="text-black hover:underline">
                                {language === "en"
                                    ? translations.en.GoogleFamilyLink
                                    : language === "am"
                                        ? translations.am.GoogleFamilyLink
                                        : language == "om" ? translations.om.GoogleFamilyLink : ""}
                            </a>
                        </li>
                            ...
                            <a href="#" className="text-black hover:underline">
                                {language === "en"
                                    ...
                                    : language === "am"
                                        ...
                                        : language == "om" ? translations.om.FamilyLinkNotWorking : ""}
                            </a>
                        </li>
                    </ul>
