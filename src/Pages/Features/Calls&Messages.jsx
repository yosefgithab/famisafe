            ...
            <div className="max-w-7xl mx-auto">
                ...
                items-center overflow-hidden rounded-lg py-16 sm:py-20">
                    ...
                    <div className="max-w-xl mx-auto text-center lg:text-left">
                        ...
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold leading-tight mb-4 sm:mb-6">
                            <span className="text-gray-700 px-2 py-1 rounded-lg inline-block">
                                {language === "en" ? translations.en.CallsMessages : language === "am" ? translations.am.CallsMessages :language === "om" ? translations.om.CallsMessages: ""}
                            </span>
                        </h1>

                        <p className="text-gray-700 text-sm sm:text-base lg:text-lg leading-6 sm:leading-7 mb-6 sm:mb-10">
                            {language === "en" ? translations.en.WithCallsMessagesparents : language === "am" ? translations.am.WithCallsMessagesparents :language === "om" ? translations.om.WithCallsMessagesparents: ""}
                        </p>
                    ...
                    <div className="w-full flex justify-center mt-6 sm:mt-10 lg:mt-0">
                        <img
                            src="https://famisafe.wondershare.com/images/fs6/call-and-messages/banner-1.png"
    ...
    "
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 sm:gap-12 lg:gap-16 items-center">
                        ...
                        <div className="lg:col-span-1 flex justify-center lg:justify-start">
                            <div className="w-[160px] sm:w-[220px] md:w-[260px] lg:w-[320px]">
                                <img
                                    src="https://famisafe.wondershare.com/images/fs6/call-and-messages/con1.png"
                                    alt="Call & Messages"
                        ...
                        <div className="lg:col-span-2 text-center lg:text-left max-w-xl sm:max-w-2xl mx-auto lg:mx-0">
                            ...
                            <p className="text-gray-700 text-sm sm:text-base lg:text-lg leading-6 sm:leading-7 mb-5 sm:mb-6">
                                {language === "en" ? translations.en.Effortlesslymonitorchildren : language === "am" ? translations.am.Effortlesslymonitorchildren : language === "om" ?translations.om.Effortlesslymonitorchildren: ""}
                            </p>

                            <ul className="list-disc list-inside space-y-2 sm:space-y-3 text-gray-600 text-sm sm:text-base">
                                <li>{language === "en" ? translations.en.FamiSafeBestAppto : language === "am" ? translations.am.FamiSafeBestAppto : language === "om" ? translations.om.FamiSafeBestAppto: ""}</li>
                                <li> {language === "en" ? translations.en.FamiSafeBestAppto : language === "am" ? translations.am.FamiSafeBestAppto : language === "om" ? translations.om.FamiSafeBestAppto: ""}</li>
                                <li>{language === "en" ? translations.en.Identifysuspicious : language === "am" ? translations.am.Identifysuspicious : language === "om" ? translations.om.Identifysuspicious: ""}</li>
                            </ul>
                ...
                <div className="bg-white py-20 max-w-6xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="lg:col-span-2 text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
                        <h2 className="text-3xl sm:text-4xl font-extrabold mb-6 text-gray-800">
                            {language === "en" ? translations.en.SuspiciousContentDetection : language === "am" ? translations.am.SuspiciousContentDetection : language === "om" ? translations.om.SuspiciousContentDetection: ""}
                        </h2>

                        <p className="text-gray-700 text-base sm:text-lg leading-4 mb-6">
                            {language === "en" ? translations.en.Safeguardyourchildren : language === "am" ? translations.am.Safeguardyourchildren : language === "om" ? translations.om.Safeguardyourchildren: ""}
                        </p>

                        <ul className="list-disc list-inside space-y-0 text-gray-600 text-sm sm:text-basise">
                            <li>{language === "en" ? translations.en.Detectandhighlight : language === "am" ? translations.am.Detectandhighlight :language === "om" ? translations.om.Detectandhighlight: ""}</li>
                            <li>{language === "en" ? translations.en.Combinemessage : language === "am" ? translations.am.Combinemessage : language === "om" ? translations.om.Combinemessage: ""}</li>
                            <li>{language === "en" ? translations.en.Protectyour : language === "am" ? translations.am.Protectyour : language === "om" ? translations.om.Protectyour: ""}</li>
                        </ul>
                    </div>
            ...
            <div className="bg-[#EFFFFB] max-w-7xl mx-auto py-16 lg:py-20 rounded-lg">
                ...
                <h2 className="text-center text-2xl sm:text-3xl lg:text-4xl font-extrabold text-gray-900 mb-12">
                    {language === "en" ? translations.en.HowtoTrack : language === "am" ? translations.am.HowtoTrack :language === "om" ? translations.om.HowtoTrack: ""}
                </h2>
          ...
          shadow-sm group-hover:shadow-lg"
                ...
                <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
                    ...
                    <ul className="space-y-5 text-base text-black md:text-lg">
                        <li className="flex items-start gap-3">
                            ...
                            {language === "en" ? translations.en.BestCallBlocker : language === "am" ? translations.am.BestCallBlocker : language === "om" ? translations.om.BestCallBlocker: ""}
                        </li>
                        <li className="flex items-start gap-3">
                            <span className="mt-2 h-2 w-2 rounded-full bg-black"></span>
                            {language === "en" ? translations.en.TopBest : language === "am" ? translations.am.TopBest : language === "om" ? translations.om.TopBest: ""}
                        </li>
                        <li className="flex items-start gap-3">
                            <span className="mt-2 h-2 w-2 rounded-full bg-black"></span>
                            {language === "en" ? translations.en.TopWaystoTrack : language === "am" ? translations.am.TopWaystoTrack : language === "om" ? translations.om.TopWaystoTrack: ""}
                        </li>
                    </ul>
                    ...
                    <ul className="space-y-5 text-base text-black md:text-lg">
                        <li className="flex items-start gap-3">
                            <span className="mt-2 h-2 w-2 rounded-full bg-black"></span>
                            {language === "en" ? translations.en.HowToCheck : language === "am" ? translations.am.HowToCheck : language === "om" ?translations.om.HowToCheck: ""}
                        </li>
                        <li className="flex items-start gap-3">
                            <span className="mt-2 h-2 w-2 rounded-full bg-black"></span>
                            {language === "en" ? translations.en.OmegleforKids : language === "am" ? translations.am.OmegleforKids :language === "om" ? translations.om.OmegleforKids: ""}
                        </li>
                        <li className="flex items-start gap-3">
                            <span className="mt-2 h-2 w-2 rounded-full bg-black"></span>
                            {language === "en" ? translations.en.BestTextMessage : language === "am" ? translations.am.BestTextMessage : language === "om" ?translations.om.BestTextMessage: ""}
                        </li>
                    </ul>
            ...
            <br />
            <div className=" border mx-auto max-w-6xl rounded-3xl bg-gradient-to-r from-[#EFFFFA] via-[#F2F6FF] to-[#F6EEFF]  px-6py-16 md:px-12  md:py-20 text-center ">
                {/* Logo + Brand */}
