...
export default function DetectSuspiciousphotos() {
    ...
    const faqas = language === "en" ? translations.en.faqas : language === "am" ? translations.am.faqas : language == 'om' ? translations.om.faqas : "";
            ...
            <div className="max-w-7xl mx-auto">
                ...
                items-center overflow-hidden rounded-lg py-16 sm:py-20">
                    ...
                    <div className="max-w-xl mx-auto text-center lg:text-left">
                        ...
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold leading-tight mb-4 sm:mb-6">
                            <span className="text-gray-700 px-2 py-1 rounded-lg inline-block">
                                {language === "en" ? translations.en.DetectSuspicihhyousPhotos : language === "am" ? translations.am.DetectSuspicihhyousPhotos : language == "om" ? translations.om.DetectSuspicihhyousPhotos : ""}
                            </span>
                        </h1>

                        <p className="text-gray-700 text-sm sm:text-base lg:text-lg leading-6 sm:leading-7 mb-6 sm:mb-10">
                            {language === "en" ? translations.en.Detectsuspyyticiousimages : language === "am" ? translations.am.Detectsuspyyticiousimages : language == "om" ? translations.om.Detectsuspyyticiousimages : ""}
                        </p>
                    ...
                    <div className="w-full flex justify-center mt-6 sm:mt-10 lg:mt-0">
                        <img
                            src="https://famisafe.wondershare.com/images/fs6/inapp-pic/banner.png"
    ...
    "
                    >
                        {language === "en" ? translations.en.Minimize65TheExposurea : language === "am" ? translations.am.Minimize65TheExposurea : language == "om" ? translations.om.Minimize65TheExposurea : ""}
                    </h3>
                </div>
                ...
                <div className="bg-white py-14 sm:py-16 lg:py-20 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 items-center">
                        ...
                        <div className="flex justify-center lg:justify-start">
                            <div className="w-[200px] sm:w-[260px] md:w-[300px] lg:w-[360px]">
                                <img
                                    src="https://famisafe.wondershare.com/images/fs6/inapp-pic/con1.png"
                                    alt="Call & Messages"
                        ...
                        <div className="text-center lg:text-left max-w-xl mx-auto lg:mx-0">
                            ...
                            <h2 className="text-3xl sm:text-3xl lg:text-4xl font-extrabold mb-4 sm:mb-6 text-gray-800 leading-tight">
                                {language === "en"
                                    ? translations.en.MonitytrorKidAlbum
                                    : language === "am"
                                        ? translations.am.MonitytrorKidAlbum
                                        : language == "om" ? translations.om.MonitytrorKidAlbum : ""}
                            </h2>

                            <p className="text-gray-700 text-sm text-bold lg:text-lg leading-6 sm:leading-7 mb-5 sm:mb-6">
                                {language === "en"
                                    ? translations.en.Monitorhfdkidsalbums
                                    : language === "am"
                                        ? translations.am.Monitorhfdkidsalbums
                                        : language == "om" ? translations.om.Monitorhfdkidsalbums : ""}
                            </p>

                            <ul className="list-disc list-inside space-y-2 sm:space-y-3 text-gray-600 text-sm sm:text-base">
                                <li>
                                    {language === "en"
                                        ? translations.en.Tracksuspigggciousi
                                        : language === "am"
                                            ? translations.am.Tracksuspigggciousi
                                            : language == "om" ? translations.om.Tracksuspigggciousi : ""}
                                </li>
                                <li>
                                    {language === "en"
                                        ? translations.en.Adjusttheaoiiccuracy
                                        : language === "am"
                                            ? translations.am.Adjusttheaoiiccuracy
                                            : language == "om" ? translations.om.Adjusttheaoiiccuracy : ""}
                                </li>
                                <li>
                                    {language === "en"
                                        ? translations.en.Viewsuspiciousyytpictu
                                        : language === "am"
                                            ? translations.am.Viewsuspiciousyytpictu
                                            : language == "om" ? translations.om.Viewsuspiciousyytpictu : ""}
                                </li>
                            </ul>
                ...
                <div className="bg-white py-20 max-w-6xl mx-auto px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                        ...
                        <div className="order-2 lg:order-1 text-center lg:text-left max-w-xl mx-auto lg:mx-0">
                            <h2 className="text-3xl sm:text-4xl font-extrabold mb-6 text-gray-800">
                                {language === "en"
                                    ? translations.en.ReceivbveAlerts
                                    : language === "am"
                                        ? translations.am.ReceivbveAlerts
                                        : language == 'om' ? translations.om.ReceivbveAlerts : ""}
                            </h2>

                            <p className="text-gray-700 text-base sm:text-lg leading-7 mb-6">
                                {language === "en"
                                    ? translations.en.Whensuspdfgiciouspictures
                                    : language === "am"
                                        ? translations.am.Whensuspdfgiciouspictures
                                        : language == 'om' ? translations.om.Whensuspdfgiciouspictures : ""}
                            </p>

                            <ul className="list-disc list-inside space-y-2 text-gray-600 text-sm sm:text-base">
                                <li>
                                    {language === "en"
                                        ? translations.en.warningdfgoncedetect
                                        : language === "am"
                                            ? translations.am.warningdfgoncedetect
                                            : language == 'om' ? translations.om.warningdfgoncedetect : ""}
                                </li>
                                <li>
                                    {language === "en"
                                        ? translations.en.Knowwhidfgchkidsde
                                        : language === "am"
                                            ? translations.am.Knowwhidfgchkidsde
                                            : language == 'om' ? translations.om.Knowwhidfgchkidsde : ""}
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
                            <div className="w-[260px] sm:w-[320px] lg:w-[380px]">
                                <img
                                    src="https://famisafe.wondershare.com/images/fs6/inapp-pic/con2.png"
                                    alt="Text Message Monitoring"
                                    className="w-full h-auto object-contain"
                                />
                            </div>
                        </div>
                ...
                <div className="bg-white py-20 max-w-6xl mx-auto px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                        ...
                        {/* LEFT IMAGE (50%) */}
                        <div className="flex justify-center lg:justify-start">
                            <div className="w-[180px] sm:w-[260px] lg:w-[320px]">
                                <img
                                    src="https://famisafe.wondershare.com/images/fs6/inapp-pic/con3.png"
                                    alt="Call & Messages"
                                    className="w-full h-auto object-contain"
                                />
                            </div>
                        ...
                        <div className="text-center lg:text-left max-w-xl mx-auto lg:mx-0">
                            <h2 className="text-3xl sm:text-4xl font-extrabold mb-6 text-gray-800">
                                {language === "en"
                                    ? translations.en.DealWithhePhotos
                                    : language === "am"
                                        ? translations.am.DealWithhePhotos
                                        : language == 'om' ? translations.om.DealWithhePhotos : ""}
                            </h2>

                            <p className="text-gray-700 text-base sm:text-lg leading-6 mb-6">
                                {language === "en"
                                    ? translations.en.Parentscancheckt
                                    : language === "am"
                                        ? translations.am.Parentscancheckt
                                        : language == 'om' ? translations.om.Parentscancheckt : ""}
                            </p>

                            <ul className="list-disc list-inside space-y-2 text-gray-600 text-sm sm:text-base">
                                <li>
                                    {language === "en"
                                        ? translations.en.Viewanddirectlydele
                                        : language === "am"
                                            ? translations.am.Viewanddirectlydele
                                            : language == 'om' ? translations.om.Viewanddirectlydele : ""}
                                </li>
                                <li>
                                    {language === "en"
                                        ? translations.en.Afterdeletionthesus
                                        : language === "am"
                                            ? translations.am.Afterdeletionthesus
                                            : language == 'om' ? translations.om.Afterdeletionthesus : ""}
                                </li>
                                <li>
                                    {language === "en"
                                        ? translations.en.Contacttheidsi
                                        : language === "am"
                                            ? translations.am.Contacttheidsi
                                            : language == 'om' ? translations.om.Contacttheidsi : ""}
                                </li>
                            </ul>
                        </div>
            ...
            <div className="bg-[#EFFFFB] max-w-7xl mx-auto py-16 lg:py-20 rounded-lg">
                ...
                <h2 className="text-center text-2xl sm:text-3xl lg:text-4xl font-extrabold text-gray-900 mb-12">
                    {language === "en" ? translations.en.HowtoDetectnap : language === "am" ? translations.am.HowtoDetectnap : language == "om" ? translations.om.HowtoDetectnap : ""}
                </h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="ml-6 max-w-xl mx-auto lg:mx-0 text-center lg:text-left">
                        ...
                        <a
                            href="#more-details"
                            className="inline-block mt-6 ml-6 text-purple-600 font-medium hover:underline"
                        >
                        ...
                        <div className="mt-8">
                            <button className="ml-6 bg-purple-600 hover:bg-purple-700 transition text-white px-8 py-4 rounded-full font-semibold shadow-lg">
          ...
          shadow-sm group-hover:shadow-lg"
            ...
            <div className="mx-auto max-w-6xl rounded-3xl bg-[#F6F1FF] px-6 py-14 md:px-16 md:py-20 ">
                ...
                <h2 className="mb-12 text-center text-2xl font-semibold text-black md:text-3xl">
                    {language === "en"
                        ? translations.en.MoreTipsforSuspen
                        : language === "am"
                            ? translations.am.MoreTipsforSuspen
                            : language == "om" ? translations.om.MoreTipsforSuspen : ""}
                </h2>
                ...
                <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
                    ...
                    <ul className="space-y-5 text-base md:text-lg">
                        <li className="flex items-start gap-3">
                            ...
                            <a href="#" className="text-black hover:underline">
                                {language === "en"
                                    ? translations.en.BestPornBlockin
                                    : language === "am"
                                        ? translations.am.BestPornBlockin
                                        : language == "om" ? translations.om.BestPornBlockin : ""}
                            </a>
                        </li>
                        ...
                        <li className="flex items-start gap-3">
                            ...
                            <a href="#" className="text-black hover:underline">
                                {language === "en"
                                    ? translations.en.HowtoBlockPo
                                    : language === "am"
                                        ? translations.am.HowtoBlockPo
                                        : language == "om" ? translations.om.HowtoBlockPo : ""}
                            </a>
                        </li>
                        ...
                        <li className="flex items-start gap-3">
                            ...
                            <a href="#" className="text-black hover:underline">
                                {language === "en"
                                    ? translations.en.EffectiveSoluti
                                    : language === "am"
                                        ? translations.am.EffectiveSoluti
                                        : language == "om" ? translations.om.EffectiveSoluti : ""}
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul className="space-y-5 text-base md:text-lg">
                        <li className="flex items-start gap-3">
                            ...
                            <a href="#" className="text-black hover:underline">
                                {language === "en"
                                    ? translations.en.HowtoGetRidofP
                                    : language === "am"
                                        ? translations.am.HowtoGetRidofP
                                        : language == "om" ? translations.om.HowtoGetRidofP : ""}
                            </a>
                        </li>
                        ...
                        <li className="flex items-start gap-3">
                            ...
                            <a href="#" className="text-black hover:underline">
                                {language === "en"
                                    ? translations.en.HowtoBlockPorno
                                    : language === "am"
                                        ? translations.am.HowtoBlockPorno
                                        : language == "om" ? translations.om.HowtoBlockPorno : ""}
                            </a>
                        </li>
                        ...
                        <li className="flex items-start gap-3">
                            ...
                            <a href="#" className="text-black hover:underline">
                                {language === "en"
                                    ? translations.en.HowtoBlockAllPornite
                                    : language === "am"
                                        ? translations.am.HowtoBlockAllPornite
                                        : language == "om" ? translations.om.HowtoBlockAllPornite : ""}
                            </a>
                        </li>
                    </ul>
