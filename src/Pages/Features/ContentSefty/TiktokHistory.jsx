...
export default function TiktokHistory() {
    ...
    const faqbs = language === "en" ? translations.en.faqbs : language === "am" ? translations.am.faqbs : language == "om" ? translations.om.faqbs : "";
                ...
                items-center overflow-hidden rounded-lg py-16 sm:py-20">
                    ...
                    <div className="max-w-xl mx-auto text-center lg:text-left">
                        <p className="text-purple-600 font-semibold mb-3 sm:mb-4">
                            {language === "en" ? translations.en.FamiSafeNewFeature : language === "am" ? translations.am.FamiSafeNewFeature : language == "om" ? translations.om.FamiSafeNewFeature : "om"}
                        </p>
                        ...
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold leading-tight mb-4 sm:mb-6">
                            <span className="text-gray-700 px-2 py-1 rounded-lg inline-block">
                                {language === "en" ? translations.en.CheckKjhidsTikTok : language === "am" ? translations.am.CheckKjhidsTikTok : language == "om" ? translations.om.CheckKjhidsTikTok : ""}
                            </span>
                        </h1>

                        <p className="text-gray-700 text-sm sm:text-base lg:text-lg leading-6 sm:leading-7 mb-6 sm:mb-10">
                            {language === "en" ? translations.en.Getdetailffsaboutthe : language === "am" ? translations.am.Getdetailffsaboutthe : language == "om" ? translations.om.Getdetailffsaboutthe : ""}
                        </p>
                    ...
                    <div className="w-full flex justify-center mt-6 sm:mt-10 lg:mt-0">
                        <img
                            src="https://famisafe.wondershare.com/images/fs6/tiktok-history/banner.png"
    ...
    "
                    >
                        {language === "en" ? translations.en.TheBestWaytoPffreven : language === "am" ? translations.am.TheBestWaytoPffreven : language == "om" ? translations.om.TheBestWaytoPffreven : ""}
                    </h3>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 sm:gap-12 lg:gap-16 items-center">
                        ...
                        <div className="lg:col-span-1 flex justify-center lg:justify-start">
                            <div className="w-[160px] sm:w-[220px] md:w-[260px] lg:w-[320px]">
                                <img
                                    src="https://famisafe.wondershare.com/images/fs6/tiktok-history/con1.png"
                                    alt="Tiktok history"
                        ...
                        <div className="lg:col-span-2 text-center lg:text-left max-w-xl sm:max-w-2xl mx-auto lg:mx-0">
                            ...
                            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold mb-4 sm:mb-6 text-gray-800 leading-tight">
                                {language === "en" ? translations.en.UnderstandytrfYourKidBetter : language === "am" ? translations.am.UnderstandytrfYourKidBetter : language == "om" ? translations.om.UnderstandytrfYourKidBetter : ""}
                            </h2>

                            <p className="text-gray-700 text-sm sm:text-base lg:text-lg leading-6 sm:leading-7 mb-5 sm:mb-6">
                                {language === "en" ? translations.en.NoneedtocoionnectTikTok : language === "am" ? translations.am.NoneedtocoionnectTikTok : language == "om" ? translations.om.NoneedtocoionnectTikTok : ""}
                            </p>

                            <ul className="list-disc list-inside space-y-2 sm:space-y-3 text-gray-600 text-sm sm:text-base">
                                <li>{language === "en" ? translations.en.Getnforlljimation : language === "am" ? translations.am.Getnforlljimation : language == "om" ? translations.om.Getnforlljimation : ""}</li>
                                <li> {language === "en" ? translations.en.ClickViekkgwtoge : language === "am" ? translations.am.ClickViekkgwtoge : language == "om" ? translations.om.ClickViekkgwtoge : ""}</li>
                                <li>{language === "en" ? translations.en.Checkhowlongy : language === "am" ? translations.am.Checkhowlongy : language == "om" ? translations.om.Checkhowlongy : ""}</li>
                            </ul>
                ...
                <div className="bg-white py-20 max-w-6xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="lg:col-span-2 order-2 lg:order-1 text-center lg:text-left max-w-xl mx-auto lg:mx-0">
                        <h2 className="text-3xl sm:text-4xl font-extrabold mb-6 text-gray-800">
                            <li>{language === "en" ? translations.en.TextMessageMonitoring : language === "am" ? translations.am.TextMessageMonitoring : language == "om" ? translations.om.TextMessageMonitoring : ""}</li>
                        </h2>

                        <p className="text-gray-700 text-base sm:text-lg leading-7 mb-6">
                            {language === "en" ? translations.en.Easilymonitorthechild : language === "am" ? translations.am.Easilymonitorthechild : language == "om" ? translations.om.Easilymonitorthechild : ""}
                        </p>

                        <ul className="list-disc list-inside space-y-0 text-gray-600 text-sm sm:text-base">
                            <li> {language === "en" ? translations.en.Automaticallyrefresh : language === "am" ? translations.am.Automaticallyrefresh : language == "om" ? translations.om.Automaticallyrefresh : ""}</li>
                            <li> {language === "en" ? translations.en.Checkandviewthecontacts : language === "am" ? translations.am.Checkandviewthecontacts : language == "om" ? translations.om.Checkandviewthecontacts : ""}</li>
                            <li> {language === "en" ? translations.en.Detectsensitive : language === "am" ? translations.am.Detectsensitive : language == "om" ? translations.om.Detectsensitive : ""}</li>
                        </ul>
                    </div>
                    ...
                    <div className="lg:col-span-1 order-1 lg:order-2 relative flex justify-center lg:justify-end">
                        <div className="relative w-[260px] sm:w-[320px] lg:w-[380px]">
                            <img
                                src="https://famisafe.wondershare.com/images/fs6/tiktok-history/con2.png"
                                alt="Call & Messages"
            ...
            <div className="bg-[#EFFFFB] max-w-7xl mx-auto py-16 lg:py-20 rounded-lg">
                ...
                <h2 className="text-center text-2xl sm:text-3xl lg:text-4xl font-extrabold text-gray-900 mb-12">
                    {language === "en" ? translations.en.HowtoViewKidsTik : language === "am" ? translations.am.HowtoViewKidsTik : language == "om" ? translations.om.HowtoViewKidsTik : ""}
                </h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className=" max-w-xl mx-auto lg:mx-0 text-center lg:text-left">
                        ...
                        <div className="mt-8">
                            <button className="bg-purple-600 hover:bg-purple-700 transition text-white px-8 py-4 rounded-full font-semibold shadow-lg ml-6">
              ...
              */}
                ...
                <div className="mt-16 text-center">
                    <p className="text-sm text-gray-600 mb-6"> {language === "en" ? translations.en.DownloadFamiSafeon : language === "am" ? translations.am.DownloadFamiSafeon : translations.om.DownloadFamiSafeon}</p>
          ...
          shadow-sm group-hover:shadow-lg"
            ...
            <div className="mx-auto max-w-6xl rounded-3xl bg-[#F6F1FF] px-6 py-14 md:px-16 md:py-20 ">
                ...
                <h2 className="mb-12 text-center text-2xl font-semibold text-black md:text-3xl">
                    {language === "en"
                        ? translations.en.UltimatedeGuidetoWatc
                        : language === "am"
                            ? translations.am.UltimatedeGuidetoWatc
                            : language == "om" ? translations.om.UltimatedeGuidetoWatc : ""}
                </h2>
                ...
                <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
                    ...
                    <ul className="space-y-5 text-base md:text-lg">
                        <li className="flex items-start gap-3">
                            ...
                            <a href="#" className="text-black hover:underline">
                                {language === "en"
                                    ? translations.en.SimpleWaystRestric
                                    : language === "am"
                                        ? translations.am.SimpleWaystRestric
                                        : language == "om" ? translations.om.SimpleWaystRestric : ""}
                            </a>
                        </li>
                        ...
                        <li className="flex items-start gap-3">
                            ...
                            <a href="#" className="text-black hover:underline">
                                {language === "en"
                                    ? translations.en.BestApphosforTik
                                    : language === "am"
                                        ? translations.am.BestApphosforTik
                                        : language == "om" ? translations.om.BestApphosforTik : ""}
                            </a>
                        </li>
                        ...
                        <li className="flex items-start gap-3">
                            ...
                            <a href="#" className="text-black hover:underline">
                                {language === "en"
                                    ? translations.en.LeadingTpoikTokProfile
                                    : language === "am"
                                        ? translations.am.LeadingTpoikTokProfile
                                        : language == "om" ? translations.om.LeadingTpoikTokProfile : ""}
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul className="space-y-5 text-base md:text-lg">
                        <li className="flex items-start gap-3">
                            ...
                            <a href="#" className="text-black hover:underline">
                                {language === "en"
                                    ? translations.en.HowtoSebuntUpParenta
                                    : language === "am"
                                        ? translations.am.HowtoSebuntUpParenta
                                        : language == "om" ? translations.om.HowtoSebuntUpParenta : ""}
                            </a>
                        </li>
