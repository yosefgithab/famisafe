...
export default function WebFilter() {
  ...
  const postsa = language === "en" ? translations.en.postsa : language === "am" ? translations.am.postsa : language == "om" ? translations.om.postsa : "";
  ...
  const totalSlides = Math.ceil(postsa.length / slidesPerView);
  ...
  const faqavs = language === "en" ? translations.en.faqavs : language === "am" ? translations.am.faqavs : language == 'om' ? translations.om.faqavs : ""; 
  ...
  return (
    ...
    <section className="w-full overflow-hidden px-4 sm:px-6 lg:px-0">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-[#FFF2EE] to-[#FFF2EE] max-w-7xl mx-auto 
          ...
          <div className="max-w-xl mx-auto text-center lg:text-left">
            ...
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold leading-tight mb-4 sm:mb-6">
              <span className="text-gray-700 px-2 py-1 rounded-lg inline-block">
                {language === "en" ? translations.en.KeepKidsSearchSafe : language === "am" ? translations.am.KeepKidsSearchSafe : language == "om" ? translations.om.KeepKidsSearchSafe : ""}
              </span>
            </h1>

            <p className="text-gray-700 text-sm sm:text-base lg:text-lg leading-6 sm:leading-7 mb-6 sm:mb-10">
              {language === "en" ? translations.en.Createasafeandage : language === "am" ? translations.am.Createasafeandage : language == "om" ? translations.om.Createasafeandage : ""}
            </p>
          ...
          <div className="w-full flex justify-center mt-6 sm:mt-10 lg:mt-0">
            <img
              src="https://famisafe.wondershare.com/images/feature/2021/search-safe/activity-report.png"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12 sm:mb-16">
            <h3 className="text-lg sm:text-2xl md:text-3xl lg:text-3xl font-extrabold text-gray-900 leading-tight max-w-3xl sm:max-w-4xl mx-auto">
              {language === "en" ? translations.en.KnowYouorries : language === "am" ? translations.am.KnowYouorries : language == "om" ? translations.om.KnowYouorries : ""}
            </h3>
          </div>
  ...
  min-h-[120px] sm:min-h-[260px] lg:min-h-[200px]">
              <p className="text-sm sm:text-sm sm:text-xl text-gray-900 leading-relaxed max-w-xs">
                {language === "en" ? translations.en.Ismysonsearching : language === "am" ? translations.am.Ismysonsearching : language == "om" ? translations.om.Ismysonsearching : ""}
              </p>
            </div>
  ...
  min-h-[120px] sm:min-h-[260px] lg:min-h-[200px]">
              <p className="text-sm sm:text-lg lg:text-xl text-gray-900 leading-relaxed max-w-xs">
                {language === "en" ? translations.en.WhatcanIdtostp : language === "am" ? translations.am.WhatcanIdtostp : language == "om" ? translations.om.WhatcanIdtostp : ""}
              </p>
            </div>
  ...
  min-h-[120px] sm:min-h-[260px] lg:min-h-[200px]">
              <p className="text-sm sm:text-lg lg:text-xl text-gray-900 leading-relaxed max-w-xs">
                {language === "en" ? translations.en.Isthereawaytoblock : language === "am" ? translations.am.Isthereawaytoblock : language == "om" ? translations.om.Isthereawaytoblock : ""}
              </p>
            </div>
        ...
        <div className="text-center mb-12 sm:mb-16">
          <h3 className="text-lg sm:text-2xl md:text-3xl lg:text-3xl font-extrabold text-gray-900 leading-tight max-w-3xl sm:max-w-4xl mx-auto">
            {language === "en" ? translations.en.GuideKidstoGoo : language === "am" ? translations.am.GuideKidstoGoo : language == "om" ? translations.om.GuideKidstoGoo : ""}
          </h3>
        </div>
        <div className="border-2 border-[#F6F2F6] rounded-lg  max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center lg:items-start gap-8 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-gray-900 mb-4">
              {language === "en" ? translations.en.KeepSearchSafe : language === "am" ? translations.am.KeepSearchSafe : language == "om" ? translations.om.KeepSearchSafe : ""}
            </h2>
            <p className="text-gray-700 text-base sm:text-lg mb-4">
              {language === "en" ? translations.en.Filternappropriate : language === "am" ? translations.am.Filternappropriate : language == "om" ? translations.om.Filternappropriate : ""}
            </p>

            <ul className="list-disc list-inside space-y-2 text-gray-700 text-base sm:text-lg">
              <li>{language === "en" ? translations.en.Filterwebsitesby : language === "am" ? translations.am.Filterwebsitesby : language == "om" ? translations.om.Filterwebsitesby : ""}</li>
              <li>{language === "en" ? translations.en.Poweredby0inbuilt : language === "am" ? translations.am.Poweredby0inbuilt : language == "om" ? translations.om.Poweredby0inbuilt : ""}</li>
              <li>
                {language === "en" ? translations.en.EnableSafeSearchto : language === "am" ? translations.am.EnableSafeSearchto : language == "om" ? translations.om.EnableSafeSearchto : ""}
              </li>
            </ul>
          </div>
        ...
        <br /><div className="border-2 border-[#F6F2F6] rounded-lg max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center lg:items-start gap-8 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2 order-2 lg:order-1">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-gray-900 mb-4">
              {language === "en" ? translations.en.SafeguardKid : language === "am" ? translations.am.SafeguardKid : language == "om" ? translations.om.SafeguardKid : ""}
            </h2>
            <p className="text-gray-700 text-base sm:text-lg mb-4">
              {language === "en" ? translations.en.Setahealthyspacema : language === "am" ? translations.am.Setahealthyspacema : language == "om" ? translations.om.Setahealthyspacema : ""}
            </p>

            <ul className="list-disc list-inside space-y-2 text-gray-700 text-base sm:text-lg">
              <li>{language === "en" ? translations.en.Feelfreetoadda : language === "am" ? translations.am.Feelfreetoadda : language == "om" ? translations.om.Feelfreetoadda : ""}</li>
              <li>{language === "en" ? translations.en.Changethewebfilter : language === "am" ? translations.am.Changethewebfilter : language == "om" ? translations.om.Changethewebfilter : ""}</li>
              <li>
                {language === "en" ? translations.en.UseSafearchtoen : language === "am" ? translations.am.UseSafearchtoen : language == "om" ? translations.om.UseSafearchtoen : ""}

              </li>
              <li>

                {language === "en" ? translations.en.ForiOSdevicestheaf : language === "am" ? translations.am.ForiOSdevicestheaf : language == "om" ? translations.om.ForiOSdevicestheaf : ""}
              </li>
            </ul>
          </div>
        ...
        <div className="border-2 border-[#F6F2F6] rounded-lg  max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center lg:items-start gap-8 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-gray-900 mb-4">
              {language === "en" ? translations.en.KnowWhatidsBrows : language === "am" ? translations.am.KnowWhatidsBrows : language == "om" ? translations.om.KnowWhatidsBrows : ""}
            </h2>
            <p className="text-gray-700 text-base sm:text-lg mb-4">
              {language === "en" ? translations.en.Learnwhatkidsarese : language === "am" ? translations.am.Learnwhatkidsarese : language == "om" ? translations.om.Learnwhatkidsarese : ""}
            </p>

            <ul className="list-disc list-inside space-y-2 text-gray-700 text-base sm:text-lg">
              <li>{language === "en" ? translations.en.Checkbrowserhistory : language === "am" ? translations.am.Checkbrowserhistory : language == "om" ? translations.om.Checkbrowserhistory : ""}</li>
              <li>{language === "en" ? translations.en.Storeupto3monthsof : language === "am" ? translations.am.Storeupto3monthsof : language == "om" ? translations.om.Storeupto3monthsof : ""}</li>
              <li>
                {language === "en" ? translations.en.Findoutwhichwordte : language === "am" ? translations.am.Findoutwhichwordte : language == "om" ? translations.om.Findoutwhichwordte : ""}
              </li>
            </ul>
          </div>
