...
export default function ActivityReport() {
    ...
    const faqxs = language === "en" ? translations.en.faqxs : language === "am" ? translations.am.faqxs : language == "om" ? translations.om.faqxs : "";
    ...
    return (
        <section className="w-full overflow-hidden px-4 sm:px-6 lg:px-0">
            <div className=" max-w-7xl mx-auto">
                {/* <section className="bg-gradient-to-r from-[#F4EEFF] to-[#FFF7EF] max-w-7xl mx-auto px-4 py-16 sm:py-20 overflow-hidden items-center"> */}
                <div className="bg-gradient-to-r from-[#F4EEFF] to-[#FFF7EF] max-w-7xl mx-auto 
                ...
                items-center overflow-hidden rounded-lg py-16 sm:py-20">
                    ...
                    <div className="max-w-xl mx-auto text-center lg:text-left">
                        ...
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold leading-tight mb-4 sm:mb-6">
                            <span className="text-gray-700 px-2 py-1 rounded-lg inline-block">
                                {language === "en" ? translations.en.ActivityReport : language === "am" ? translations.am.ActivityReport : language == "om" ? translations.om.ActivityReport : ""}
                            </span>
                        </h1>

                        <p className="text-gray-700 text-sm sm:text-base lg:text-lg leading-6 sm:leading-7 mb-6 sm:mb-10">
                            {language === "en" ? translations.en.Monitoringkidsphones : language === "am" ? translations.am.Monitoringkidsphones : language == "om" ? translations.om.Monitoringkidsphones : ""}
                        </p>
                    ...
                    <div className="w-full flex justify-center mt-6 sm:mt-10 lg:mt-0">
                        <img
                            src="https://famisafe.wondershare.com/images/fs6/activily-report/banner.png"
                ...
                <div className="bg-white py-10 sm:py-12 max-w-6xl mx-auto px-4 lg:px-6 flex justify-center">
                    ...
                    >
                        {language === "en" ? translations.en.GetTheDetailof : language === "am" ? translations.am.GetTheDetailof : language == "om" ? translations.om.GetTheDetailof : ""}
                    </h3>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 sm:gap-12 lg:gap-16 items-center">
                        ...
                        <div className="lg:col-span-1 flex justify-center lg:justify-start">
                            <div className="w-[160px] sm:w-[220px] md:w-[260px] lg:w-[320px]">
                                <img
                                    src="https://famisafe.wondershare.com/images/fs6/activily-report/con1.png"
                                    alt="Call & Messages"
                        ...
                        <div className="lg:col-span-2 text-center lg:text-left max-w-xl sm:max-w-2xl mx-auto lg:mx-0">
                            ...
                            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold mb-4 sm:mb-6 text-gray-800 leading-tight">
                                {language === "en" ? translations.en.CallHistoryMonitoring : language === "am" ? translations.am.CallHistoryMonitoring : language== "om" ?translations.om.CallHistoryMonitoring: ""}
                            </h2>

                            <p className="text-gray-700 text-sm sm:text-base lg:text-lg leading-6 font-extrabold sm:leading-7 mb-5 sm:mb-6">
                                {language === "en" ? translations.en.MakeYourOwnJudgemen : language === "am" ? translations.am.MakeYourOwnJudgemen : language == "om" ? translations.om.MakeYourOwnJudgemen : ""}
                            </p>

                            <ul className="list-disc list-inside space-y-2 sm:space-y-3 text-gray-600 text-sm sm:text-base">
                                <li>{language === "en" ? translations.en.Viewyourkids : language === "am" ? translations.am.Viewyourkids : language == "om" ? translations.om.Viewyourkids : ""}</li>
                                <li> {language === "en" ? translations.en.FamiSafeBestAppto : language === "am" ? translations.am.FamiSafeBestAppto : language == "om" ? translations.om.Learnwhenandwhich : ""}</li>
                                <li>{language === "en" ? translations.en.Knowwhetheryourkids : language === "am" ? translations.am.Knowwhetheryourkids : language == "om" ? translations.om.Knowwhetheryourkids : ""}</li>
                            </ul>
                ...
                <div className="bg-white py-20 max-w-6xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="lg:col-span-2 order-2 lg:order-1 text-center lg:text-left max-w-xl mx-auto lg:mx-0">
                        <h2 className="text-3xl sm:text-4xl font-extrabold mb-6 text-gray-800">
                            <li>{language === "en" ? translations.en.GetFullDetailsof : language === "am" ? translations.am.GetFullDetailsof : language == "om" ? translations.om.GetFullDetailsof : ""}</li>
                        </h2>

                        <p className="text-gray-700 text-bold sm:text-lg leading-7 mb-6">
                            {language === "en" ? translations.en.Getridofthetrouble : language === "am" ? translations.am.Getridofthetrouble : language == "om" ? translations.om.Getridofthetrouble : ""}
                        </p>

                        <ul className="list-disc list-inside space-y-0 text-gray-600 text-sm sm:text-base">
                            <li> {language === "en" ? translations.en.Getthemostreliable : language === "am" ? translations.am.Getthemostreliable : language == "om" ? translations.om.Getthemostreliable : ""}</li>
                            <li> {language === "en" ? translations.en.Bestwaytomonitor : language === "am" ? translations.am.Bestwaytomonitor : language == "om" ? translations.om.Bestwaytomonitor : ""}</li>
                            <li> {language === "en" ? translations.en.Reviewwhichvideos : language === "am" ? translations.am.Reviewwhichvideos : language == "om" ? translations.om.Reviewwhichvideos : ""}</li>
                        </ul>
                    </div>
                    ...
                    <div className="lg:col-span-1 order-1 lg:order-2 relative flex justify-center lg:justify-end">
                        <div className="relative w-[260px] sm:w-[320px] lg:w-[380px]">
                            <img
                                src="https://famisafe.wondershare.com/images/fs6/activily-report/con2.png"
                                alt="Call & Messages"
                ...
                <div className="bg-white py-20 max-w-6xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="lg:col-span-1 relative flex justify-center lg:justify-start">
                        <div className="relative w-[180px] sm:w-[260px] lg:w-[320px]">
                            <img
                                src="https://famisafe.wondershare.com/images/fs6/activily-report/con3.png"
                                alt="Call & Messages"
                                className="w-full h-auto "
                            />
                        </div>
                    ...
                    <div className="lg:col-span-2 text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
                        <h2 className="text-3xl sm:text-4xl font-extrabold mb-6 text-gray-800">
                            {language === "en" ? translations.en.GetKidsDeviceApplication : language === "am" ? translations.am.GetKidsDeviceApplication : language == "om" ? translations.om.GetKidsDeviceApplication : ""}
                        </h2>

                        <p className="text-gray-700 text-base sm:text-lg leading-4 mb-6">
                            {language === "en" ? translations.en.Keepuptodatewiththe : language === "am" ? translations.am.Keepuptodatewiththe : language == "om" ? translations.om.Keepuptodatewiththe : ""}
                        </p>

                        <ul className="list-disc list-inside space-y-0 text-gray-600 text-sm sm:text-basise">
                            <li>{language === "en" ? translations.en.Graspthemostrecently : language === "am" ? translations.am.Graspthemostrecently : language == "om" ? translations.om.Graspthemostrecently : ""}</li>
                            <li>{language === "en" ? translations.en.Switchdatestoviewkids : language === "am" ? translations.am.Switchdatestoviewkids : language == "om" ? translations.om.Switchdatestoviewkids : ""}</li>
                            <li>{language === "en" ? translations.en.Checkyourkidsdevices : language === "am" ? translations.am.Checkyourkidsdevices : language == "om" ? translations.om.Checkyourkidsdevices : ""}</li>
                        </ul>
                    </div>
            ...
            <div className="bg-[#EFFFFB] max-w-7xl mx-auto py-16 lg:py-20 rounded-lg ">
                ...
                <h2 className="text-center text-2xl sm:text-3xl lg:text-4xl font-extrabold text-gray-900 mb-12">
                    {language === "en" ? translations.en.HowtoChecktheActivity : language === "am" ? translations.am.HowtoChecktheActivity : language == "om" ? translations.om.HowtoChecktheActivity : ""}
                </h2>

                {/* MAIN GRID */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center ml-6">
                        ...
                        <div className="space-y-6 text-gray-800">
                            <div>
                                ...
                                <p className="text-sm text-gray-600">
                                    {language === "en" ? translations.en.DownloadFamiSafeApp : language === "am" ? translations.am.DownloadFamiSafeApp : language == "om" ? translations.om.DownloadFamiSafeApp : ""}
                                </p>
                            </div>

                            <div>
                                <h4 className="font-bold"> {language === "en" ? translations.en.StepRegisteranAccount : language === "am" ? translations.am.StepRegisteranAccount : language == "om" ? translations.om.StepRegisteranAccount : ""}</h4>
                                <p className="text-sm text-gray-600">
                                    {language === "en" ? translations.en.Register : language === "am" ? translations.am.Register : language == "om" ? translations.om.Register : ""}
                                </p>
                            </div>

                            <div>
                                <h4 className="font-bold">{language === "en" ? translations.en.StepConnect : language === "am" ? translations.am.StepConnect : language == "om" ? translations.om.StepConnect : ""}</h4>
                                <p className="text-sm text-gray-600">
                                    {language === "en" ? translations.en.Scanthe : language === "am" ? translations.am.Scanthe : language == "om" ? translations.om.Scanthe : ""}
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-4 ">
                        {appStores.map((store) => (
                            <a
                                ...
                                className=" border-1 text-[#7755D2]
          ...
          shadow-sm group-hover:shadow-lg"
            ...
            <div className="mx-auto max-w-6xl rounded-3xl bg-[#F6F1FF] px-6 py-14 md:px-16 md:py-20 ">

                {/* Title */}
                <h2 className="mb-12 text-center text-2xl font-semibold text-black md:text-3xl">
                    {language === "en"
                        ? translations.en.MoreTipsforMonitoring
                        : language === "am"
                            ? translations.am.MoreTipsforMonitoring
                            : language == "om" ? translations.om.MoreTipsforMonitoring : ""}
                </h2>
                ...
                <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
                    ...
                    <ul className="space-y-5 text-base md:text-lg">
                        <li className="flex items-start gap-3">
                            ...
                            <a href="#" className="text-black hover:underline">
                                {language === "en"
                                    ? translations.en.To9BestFree
                                    : language === "am"
                                        ? translations.am.To9BestFree
                                        : language == "om" ? translations.om.To9BestFree : ""}
                            </a>
                        </li>
                        ...
                        <li className="flex items-start gap-3">
                            ...
                            <a href="#" className="text-black hover:underline">
                                {language === "en"
                                    ? translations.en.Top6BestAI
                                    : language === "am"
                                        ? translations.am.Top6BestAI
                                        : language == "om" ? translations.om.Top6BestAI : ""}
                            </a>
                        </li>
                        ...
                        <li className="flex items-start gap-3">
                            ...
                            <a href="#" className="text-black hover:underline">
                                {language === "en"
                                    ? translations.en.BestiOSParentalControl
                                    : language === "am"
                                        ? translations.am.BestiOSParentalControl
                                        : language == "om" ? translations.om.BestiOSParentalControl : ""}
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul className="space-y-5 text-base md:text-lg">
                        <li className="flex items-start gap-3">
                            ...
                            <a href="#" className="text-black hover:underline">
                                {language === "en"
                                    ? translations.en.HowtoUseActivityMonitor
                                    : language === "am"
                                        ? translations.am.HowtoUseActivityMonitor
                                        : language == "om" ? translations.om.HowtoUseActivityMonitor : ""}
                            </a>
                        </li>
                        ...
                        <li className="flex items-start gap-3">
                            ...
                            <a href="#" className="text-black hover:underline">
                                {language === "en"
                                    ? translations.en.HowtoSeeWhatMyKidisDoing
                                    : language === "am"
                                        ? translations.am.HowtoSeeWhatMyKidisDoing
                                        : language == "om" ? translations.om.HowtoSeeWhatMyKidisDoing : ""}
                            </a>
                        </li>
                        ...
                        <li className="flex items-start gap-3">
                            ...
                            <a href="#" className="text-black hover:underline">
                                {language === "en"
                                    ? translations.en.Top10BestFreePhoneMonitoringApps
                                    : language === "am"
                                        ? translations.am.Top10BestFreePhoneMonitoringApps
                                        : language == "om" ? translations.om.Top10BestFreePhoneMonitoringApps : ""}
                            </a>
                        </li>
                    </ul>
